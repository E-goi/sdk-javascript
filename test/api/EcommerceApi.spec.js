...
(function(root, factory) {
  ...
  describe('EcommerceApi', function() {
    ...
    describe('importOrdersBulk', function() {
      it('should call importOrdersBulk successfully', function(done) {
        //uncomment below and update the code to test importOrdersBulk
        //instance.importOrdersBulk(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
