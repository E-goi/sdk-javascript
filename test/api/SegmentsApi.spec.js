...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.SegmentsApi();
  });
  ...
  describe('SegmentsApi', function() {
    ...
    describe('getAllSegments', function() {
      it('should call getAllSegments successfully', function(done) {
        //uncomment below and update the code to test getAllSegments
        //instance.getAllSegments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
