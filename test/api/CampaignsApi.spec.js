...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignsApi();
  });
  ...
  describe('CampaignsApi', function() {
    describe('deleteCampaigns', function() {
      it('should call deleteCampaigns successfully', function(done) {
        //uncomment below and update the code to test deleteCampaigns
        //instance.deleteCampaigns(function(error) {
