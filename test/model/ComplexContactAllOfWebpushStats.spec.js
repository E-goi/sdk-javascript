...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ComplexContactAllOfWebpushStats();
  });
  ...
  describe('ComplexContactAllOfWebpushStats', function() {
    it('should create an instance of ComplexContactAllOfWebpushStats', function() {
      // uncomment below and update the code to test ComplexContactAllOfWebpushStats
      //var instance = new egoisdk.ComplexContactAllOfWebpushStats();
      //expect(instance).to.be.a(egoisdk.ComplexContactAllOfWebpushStats);
    });
