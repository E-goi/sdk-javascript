...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateSmsBouncesReport();
  });
  ...
  describe('GenerateSmsBouncesReport', function() {
    it('should create an instance of GenerateSmsBouncesReport', function() {
      // uncomment below and update the code to test GenerateSmsBouncesReport
      //var instance = new egoisdk.GenerateSmsBouncesReport();
      //expect(instance).to.be.a(egoisdk.GenerateSmsBouncesReport);
    });
