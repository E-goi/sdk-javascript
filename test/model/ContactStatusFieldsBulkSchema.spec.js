...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatusFieldsBulkSchema();
  });
  ...
  describe('ContactStatusFieldsBulkSchema', function() {
    it('should create an instance of ContactStatusFieldsBulkSchema', function() {
      // uncomment below and update the code to test ContactStatusFieldsBulkSchema
      //var instance = new egoisdk.ContactStatusFieldsBulkSchema();
      //expect(instance).to.be.a(egoisdk.ContactStatusFieldsBulkSchema);
    });
