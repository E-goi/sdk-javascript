...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.VoiceCampaignAllOf();
  });
  ...
  describe('VoiceCampaignAllOf', function() {
    it('should create an instance of VoiceCampaignAllOf', function() {
      // uncomment below and update the code to test VoiceCampaignAllOf
      //var instance = new egoisdk.VoiceCampaignAllOf();
      //expect(instance).to.be.a(egoisdk.VoiceCampaignAllOf);
    });
