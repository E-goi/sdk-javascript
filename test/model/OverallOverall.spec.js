...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.OverallOverall();
  });
  ...
  describe('OverallOverall', function() {
    it('should create an instance of OverallOverall', function() {
      // uncomment below and update the code to test OverallOverall
      //var instance = new egoisdk.OverallOverall();
      //expect(instance).to.be.a(egoisdk.OverallOverall);
    });
