...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateSendsReport();
  });
  ...
  describe('GenerateSendsReport', function() {
    it('should create an instance of GenerateSendsReport', function() {
      // uncomment below and update the code to test GenerateSendsReport
      //var instance = new egoisdk.GenerateSendsReport();
      //expect(instance).to.be.a(egoisdk.GenerateSendsReport);
    });
