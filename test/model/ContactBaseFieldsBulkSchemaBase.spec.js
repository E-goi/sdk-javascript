...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseFieldsBulkSchemaBase();
  });
  ...
  describe('ContactBaseFieldsBulkSchemaBase', function() {
    it('should create an instance of ContactBaseFieldsBulkSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseFieldsBulkSchemaBase
      //var instance = new egoisdk.ContactBaseFieldsBulkSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseFieldsBulkSchemaBase);
    });
