...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CellphoneSender();
  });
  ...
  describe('CellphoneSender', function() {
    it('should create an instance of CellphoneSender', function() {
      // uncomment below and update the code to test CellphoneSender
      //var instance = new egoisdk.CellphoneSender();
      //expect(instance).to.be.a(egoisdk.CellphoneSender);
    });
