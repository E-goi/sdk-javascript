...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.NumericCellphoneSender();
  });
  ...
  describe('NumericCellphoneSender', function() {
    it('should create an instance of NumericCellphoneSender', function() {
      // uncomment below and update the code to test NumericCellphoneSender
      //var instance = new egoisdk.NumericCellphoneSender();
      //expect(instance).to.be.a(egoisdk.NumericCellphoneSender);
    });
