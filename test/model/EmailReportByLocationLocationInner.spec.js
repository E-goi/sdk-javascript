...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByLocationLocationInner();
  });
  ...
  describe('EmailReportByLocationLocationInner', function() {
    it('should create an instance of EmailReportByLocationLocationInner', function() {
      // uncomment below and update the code to test EmailReportByLocationLocationInner
      //var instance = new egoisdk.EmailReportByLocationLocationInner();
      //expect(instance).to.be.a(egoisdk.EmailReportByLocationLocationInner);
    });
