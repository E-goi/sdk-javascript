...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseExtraBulk();
  });
  ...
  describe('ContactBaseExtraBulk', function() {
    it('should create an instance of ContactBaseExtraBulk', function() {
      // uncomment below and update the code to test ContactBaseExtraBulk
      //var instance = new egoisdk.ContactBaseExtraBulk();
      //expect(instance).to.be.a(egoisdk.ContactBaseExtraBulk);
    });
