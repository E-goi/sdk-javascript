...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ImportContactsWebhookData();
  });
  ...
  describe('ImportContactsWebhookData', function() {
    it('should create an instance of ImportContactsWebhookData', function() {
      // uncomment below and update the code to test ImportContactsWebhookData
      //var instance = new egoisdk.ImportContactsWebhookData();
      //expect(instance).to.be.a(egoisdk.ImportContactsWebhookData);
    });
