...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ImportOrdersBulkBulkRequest();
  });
  ...
  describe('ImportOrdersBulkBulkRequest', function() {
    it('should create an instance of ImportOrdersBulkBulkRequest', function() {
      // uncomment below and update the code to test ImportOrdersBulkBulkRequest
      //var instance = new egoisdk.ImportOrdersBulkBulkRequest();
      //expect(instance).to.be.a(egoisdk.ImportOrdersBulkBulkRequest);
    });
