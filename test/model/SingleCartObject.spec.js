...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.SingleCartObject();
  });
  ...
  describe('SingleCartObject', function() {
    it('should create an instance of SingleCartObject', function() {
      // uncomment below and update the code to test SingleCartObject
      //var instance = new egoisdk.SingleCartObject();
      //expect(instance).to.be.a(egoisdk.SingleCartObject);
    });
