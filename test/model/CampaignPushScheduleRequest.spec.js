...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignPushScheduleRequest();
  });
  ...
  describe('CampaignPushScheduleRequest', function() {
    it('should create an instance of CampaignPushScheduleRequest', function() {
      // uncomment below and update the code to test CampaignPushScheduleRequest
      //var instance = new egoisdk.CampaignPushScheduleRequest();
      //expect(instance).to.be.a(egoisdk.CampaignPushScheduleRequest);
    });
