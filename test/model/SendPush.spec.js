...
(function(root, factory) {
  ...
  describe('SendPush', function() {
    it('should create an instance of SendPush', function() {
      // uncomment below and update the code to test SendPush
      //var instance = new egoisdk.SendPush();
      //expect(instance).to.be.a(egoisdk.SendPush);
    });
