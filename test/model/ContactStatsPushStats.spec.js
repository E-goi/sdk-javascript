...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatsPushStats();
  });
  ...
  describe('ContactStatsPushStats', function() {
    it('should create an instance of ContactStatsPushStats', function() {
      // uncomment below and update the code to test ContactStatsPushStats
      //var instance = new egoisdk.ContactStatsPushStats();
      //expect(instance).to.be.a(egoisdk.ContactStatsPushStats);
    });
    ...
    it('should have the property notDelivered (base name: "not_delivered")', function() {
    ...
    it('should have the property lastViewDate (base name: "last_view_date")', function() {
      // uncomment below and update the code to test the property lastViewDate
      //var instance = new egoisdk.ContactStatsPushStats();
      //expect(instance).to.be();
    });
