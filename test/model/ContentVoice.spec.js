...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContentVoice();
  });
  ...
  describe('ContentVoice', function() {
    it('should create an instance of ContentVoice', function() {
      // uncomment below and update the code to test ContentVoice
      //var instance = new egoisdk.ContentVoice();
      //expect(instance).to.be.a(egoisdk.ContentVoice);
    });
