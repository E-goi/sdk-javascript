...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.SmsCampaign();
  });
  ...
  describe('SmsCampaign', function() {
    it('should create an instance of SmsCampaign', function() {
      // uncomment below and update the code to test SmsCampaign
      //var instance = new egoisdk.SmsCampaign();
      //expect(instance).to.be.a(egoisdk.SmsCampaign);
    });
