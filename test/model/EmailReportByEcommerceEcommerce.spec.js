...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByEcommerceEcommerce();
  });
  ...
  describe('EmailReportByEcommerceEcommerce', function() {
    it('should create an instance of EmailReportByEcommerceEcommerce', function() {
      // uncomment below and update the code to test EmailReportByEcommerceEcommerce
      //var instance = new egoisdk.EmailReportByEcommerceEcommerce();
      //expect(instance).to.be.a(egoisdk.EmailReportByEcommerceEcommerce);
    });
