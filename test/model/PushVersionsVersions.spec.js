...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoiSdk.PushVersionsVersions();
  });
  ...
  describe('PushVersionsVersions', function() {
    it('should create an instance of PushVersionsVersions', function() {
      // uncomment below and update the code to test PushVersionsVersions
      //var instance = new egoiSdk.PushVersionsVersions();
      //expect(instance).to.be.a(egoiSdk.PushVersionsVersions);
    });
