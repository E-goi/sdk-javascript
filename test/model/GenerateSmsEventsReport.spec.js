...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateSmsEventsReport();
  });
  ...
  describe('GenerateSmsEventsReport', function() {
    it('should create an instance of GenerateSmsEventsReport', function() {
      // uncomment below and update the code to test GenerateSmsEventsReport
      //var instance = new egoisdk.GenerateSmsEventsReport();
      //expect(instance).to.be.a(egoisdk.GenerateSmsEventsReport);
    });
