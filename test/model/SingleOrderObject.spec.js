...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.SingleOrderObject();
  });
  ...
  describe('SingleOrderObject', function() {
    it('should create an instance of SingleOrderObject', function() {
      // uncomment below and update the code to test SingleOrderObject
      //var instance = new egoisdk.SingleOrderObject();
      //expect(instance).to.be.a(egoisdk.SingleOrderObject);
    });
