...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseFieldsWithIdSchemaBase();
  });
  ...
  describe('ContactBaseFieldsWithIdSchemaBase', function() {
    it('should create an instance of ContactBaseFieldsWithIdSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseFieldsWithIdSchemaBase
      //var instance = new egoisdk.ContactBaseFieldsWithIdSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseFieldsWithIdSchemaBase);
    });
