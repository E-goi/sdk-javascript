...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateSubscriptionsReport();
  });
  ...
  describe('GenerateSubscriptionsReport', function() {
    it('should create an instance of GenerateSubscriptionsReport', function() {
      // uncomment below and update the code to test GenerateSubscriptionsReport
      //var instance = new egoisdk.GenerateSubscriptionsReport();
      //expect(instance).to.be.a(egoisdk.GenerateSubscriptionsReport);
    });
