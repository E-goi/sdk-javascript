...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignEmailContent();
  });
  ...
  describe('CampaignEmailContent', function() {
    it('should create an instance of CampaignEmailContent', function() {
      // uncomment below and update the code to test CampaignEmailContent
      //var instance = new egoisdk.CampaignEmailContent();
      //expect(instance).to.be.a(egoisdk.CampaignEmailContent);
    });
