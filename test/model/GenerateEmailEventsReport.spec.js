...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateEmailEventsReport();
  });
  ...
  describe('GenerateEmailEventsReport', function() {
    it('should create an instance of GenerateEmailEventsReport', function() {
      // uncomment below and update the code to test GenerateEmailEventsReport
      //var instance = new egoisdk.GenerateEmailEventsReport();
      //expect(instance).to.be.a(egoisdk.GenerateEmailEventsReport);
    });
