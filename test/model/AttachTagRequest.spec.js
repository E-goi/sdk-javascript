...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.AttachTagRequest();
  });
  ...
  describe('AttachTagRequest', function() {
    it('should create an instance of AttachTagRequest', function() {
      // uncomment below and update the code to test AttachTagRequest
      //var instance = new egoisdk.AttachTagRequest();
      //expect(instance).to.be.a(egoisdk.AttachTagRequest);
    });
