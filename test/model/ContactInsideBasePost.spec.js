...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactInsideBasePost();
  });
  ...
  describe('ContactInsideBasePost', function() {
    it('should create an instance of ContactInsideBasePost', function() {
      // uncomment below and update the code to test ContactInsideBasePost
      //var instance = new egoisdk.ContactInsideBasePost();
      //expect(instance).to.be.a(egoisdk.ContactInsideBasePost);
    });
