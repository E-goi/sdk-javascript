...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.BillingInfoAllOfBillingInfo();
  });
  ...
  describe('BillingInfoAllOfBillingInfo', function() {
    it('should create an instance of BillingInfoAllOfBillingInfo', function() {
      // uncomment below and update the code to test BillingInfoAllOfBillingInfo
      //var instance = new egoisdk.BillingInfoAllOfBillingInfo();
      //expect(instance).to.be.a(egoisdk.BillingInfoAllOfBillingInfo);
    });
    ...
    it('should have the property invoiceComments (base name: "invoice_comments")', function() {
      // uncomment below and update the code to test the property invoiceComments
      //var instance = new egoisdk.BillingInfoAllOfBillingInfo();
      //expect(instance).to.be();
    });
