...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatsWebpushStats();
  });
  ...
  describe('ContactStatsWebpushStats', function() {
    it('should create an instance of ContactStatsWebpushStats', function() {
      // uncomment below and update the code to test ContactStatsWebpushStats
      //var instance = new egoisdk.ContactStatsWebpushStats();
      //expect(instance).to.be.a(egoisdk.ContactStatsWebpushStats);
    });
    ...
    it('should have the property lastDeliveryDate (base name: "last_delivery_date")', function() {
      // uncomment below and update the code to test the property lastDeliveryDate
      //var instance = new egoisdk.ContactStatsWebpushStats();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastBounceDate (base name: "last_bounce_date")', function() {
      // uncomment below and update the code to test the property lastBounceDate
      //var instance = new egoisdk.ContactStatsWebpushStats();
      //expect(instance).to.be();
    });
