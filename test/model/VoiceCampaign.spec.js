...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.VoiceCampaign();
  });
  ...
  describe('VoiceCampaign', function() {
    it('should create an instance of VoiceCampaign', function() {
      // uncomment below and update the code to test VoiceCampaign
      //var instance = new egoisdk.VoiceCampaign();
      //expect(instance).to.be.a(egoisdk.VoiceCampaign);
    });
