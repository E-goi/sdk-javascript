...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateEmailBouncesReport();
  });
  ...
  describe('GenerateEmailBouncesReport', function() {
    it('should create an instance of GenerateEmailBouncesReport', function() {
      // uncomment below and update the code to test GenerateEmailBouncesReport
      //var instance = new egoisdk.GenerateEmailBouncesReport();
      //expect(instance).to.be.a(egoisdk.GenerateEmailBouncesReport);
    });
