...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatsTrafficStatsUtm();
  });
  ...
  describe('ContactStatsTrafficStatsUtm', function() {
    it('should create an instance of ContactStatsTrafficStatsUtm', function() {
      // uncomment below and update the code to test ContactStatsTrafficStatsUtm
      //var instance = new egoisdk.ContactStatsTrafficStatsUtm();
      //expect(instance).to.be.a(egoisdk.ContactStatsTrafficStatsUtm);
    });
