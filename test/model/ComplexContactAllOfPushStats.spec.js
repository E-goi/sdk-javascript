...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ComplexContactAllOfPushStats();
  });
  ...
  describe('ComplexContactAllOfPushStats', function() {
    it('should create an instance of ComplexContactAllOfPushStats', function() {
      // uncomment below and update the code to test ComplexContactAllOfPushStats
      //var instance = new egoisdk.ComplexContactAllOfPushStats();
      //expect(instance).to.be.a(egoisdk.ComplexContactAllOfPushStats);
    });
