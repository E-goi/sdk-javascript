...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailSender();
  });
  ...
  describe('EmailSender', function() {
    it('should create an instance of EmailSender', function() {
      // uncomment below and update the code to test EmailSender
      //var instance = new egoisdk.EmailSender();
      //expect(instance).to.be.a(egoisdk.EmailSender);
    });
