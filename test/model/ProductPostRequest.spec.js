...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ProductPostRequest();
  });
  ...
  describe('ProductPostRequest', function() {
    it('should create an instance of ProductPostRequest', function() {
      // uncomment below and update the code to test ProductPostRequest
      //var instance = new egoisdk.ProductPostRequest();
      //expect(instance).to.be.a(egoisdk.ProductPostRequest);
    });
