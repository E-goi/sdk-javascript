...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailEventsCampaignFields();
  });
  ...
  describe('EmailEventsCampaignFields', function() {
    it('should create an instance of EmailEventsCampaignFields', function() {
      // uncomment below and update the code to test EmailEventsCampaignFields
      //var instance = new egoisdk.EmailEventsCampaignFields();
      //expect(instance).to.be.a(egoisdk.EmailEventsCampaignFields);
    });
