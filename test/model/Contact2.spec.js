...
(function(root, factory) {
  ...
  describe('Contact2', function() {
    it('should create an instance of Contact2', function() {
      // uncomment below and update the code to test Contact2
      //var instance = new egoisdk.Contact2();
      //expect(instance).to.be.a(egoisdk.Contact2);
    });
