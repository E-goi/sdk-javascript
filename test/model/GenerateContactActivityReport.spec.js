...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateContactActivityReport();
  });
  ...
  describe('GenerateContactActivityReport', function() {
    it('should create an instance of GenerateContactActivityReport', function() {
      // uncomment below and update the code to test GenerateContactActivityReport
      //var instance = new egoisdk.GenerateContactActivityReport();
      //expect(instance).to.be.a(egoisdk.GenerateContactActivityReport);
    });
