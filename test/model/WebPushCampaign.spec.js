...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.WebPushCampaign();
  });
  ...
  describe('WebPushCampaign', function() {
    it('should create an instance of WebPushCampaign', function() {
      // uncomment below and update the code to test WebPushCampaign
      //var instance = new egoisdk.WebPushCampaign();
      //expect(instance).to.be.a(egoisdk.WebPushCampaign);
    });
