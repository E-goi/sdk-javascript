...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBulk();
  });
  ...
  describe('ContactBulk', function() {
    it('should create an instance of ContactBulk', function() {
      // uncomment below and update the code to test ContactBulk
      //var instance = new egoisdk.ContactBulk();
      //expect(instance).to.be.a(egoisdk.ContactBulk);
    });
