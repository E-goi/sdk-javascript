...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignSmsSendRequest();
  });
  ...
  describe('CampaignSmsSendRequest', function() {
    it('should create an instance of CampaignSmsSendRequest', function() {
      // uncomment below and update the code to test CampaignSmsSendRequest
      //var instance = new egoisdk.CampaignSmsSendRequest();
      //expect(instance).to.be.a(egoisdk.CampaignSmsSendRequest);
    });
