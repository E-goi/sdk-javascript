...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByDomainDomainInner();
  });
  ...
  describe('EmailReportByDomainDomainInner', function() {
    it('should create an instance of EmailReportByDomainDomainInner', function() {
      // uncomment below and update the code to test EmailReportByDomainDomainInner
      //var instance = new egoisdk.EmailReportByDomainDomainInner();
      //expect(instance).to.be.a(egoisdk.EmailReportByDomainDomainInner);
    });
