...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatsEmailStats();
  });
  ...
  describe('ContactStatsEmailStats', function() {
    it('should create an instance of ContactStatsEmailStats', function() {
      // uncomment below and update the code to test ContactStatsEmailStats
      //var instance = new egoisdk.ContactStatsEmailStats();
      //expect(instance).to.be.a(egoisdk.ContactStatsEmailStats);
    });
