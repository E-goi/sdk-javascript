...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.WebPushSite();
  });
  ...
  describe('WebPushSite', function() {
    it('should create an instance of WebPushSite', function() {
      // uncomment below and update the code to test WebPushSite
      //var instance = new egoisdk.WebPushSite();
      //expect(instance).to.be.a(egoisdk.WebPushSite);
    });
