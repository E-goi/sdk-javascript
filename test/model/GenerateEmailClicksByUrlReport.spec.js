...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateEmailClicksByUrlReport();
  });
  ...
  describe('GenerateEmailClicksByUrlReport', function() {
    it('should create an instance of GenerateEmailClicksByUrlReport', function() {
      // uncomment below and update the code to test GenerateEmailClicksByUrlReport
      //var instance = new egoisdk.GenerateEmailClicksByUrlReport();
      //expect(instance).to.be.a(egoisdk.GenerateEmailClicksByUrlReport);
    });
