...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.WebPushReportDevicesInner();
  });
  ...
  describe('WebPushReportDevicesInner', function() {
    it('should create an instance of WebPushReportDevicesInner', function() {
      // uncomment below and update the code to test WebPushReportDevicesInner
      //var instance = new egoisdk.WebPushReportDevicesInner();
      //expect(instance).to.be.a(egoisdk.WebPushReportDevicesInner);
    });
