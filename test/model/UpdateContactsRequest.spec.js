...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.UpdateContactsRequest();
  });
  ...
  describe('UpdateContactsRequest', function() {
    it('should create an instance of UpdateContactsRequest', function() {
      // uncomment below and update the code to test UpdateContactsRequest
      //var instance = new egoisdk.UpdateContactsRequest();
      //expect(instance).to.be.a(egoisdk.UpdateContactsRequest);
    });
