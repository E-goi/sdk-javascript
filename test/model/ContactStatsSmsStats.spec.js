...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatsSmsStats();
  });
  ...
  describe('ContactStatsSmsStats', function() {
    it('should create an instance of ContactStatsSmsStats', function() {
      // uncomment below and update the code to test ContactStatsSmsStats
      //var instance = new egoisdk.ContactStatsSmsStats();
      //expect(instance).to.be.a(egoisdk.ContactStatsSmsStats);
    });
