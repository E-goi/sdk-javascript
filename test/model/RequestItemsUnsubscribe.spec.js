...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.RequestItemsUnsubscribe();
  });
  ...
  describe('RequestItemsUnsubscribe', function() {
    it('should create an instance of RequestItemsUnsubscribe', function() {
      // uncomment below and update the code to test RequestItemsUnsubscribe
      //var instance = new egoisdk.RequestItemsUnsubscribe();
      //expect(instance).to.be.a(egoisdk.RequestItemsUnsubscribe);
    });
