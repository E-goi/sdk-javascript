...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ListCollection();
  });
  ...
  describe('ListCollection', function() {
    it('should create an instance of ListCollection', function() {
      // uncomment below and update the code to test ListCollection
      //var instance = new egoisdk.ListCollection();
      //expect(instance).to.be.a(egoisdk.ListCollection);
    });
