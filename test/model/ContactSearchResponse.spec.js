...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactSearchResponse();
  });
  ...
  describe('ContactSearchResponse', function() {
    it('should create an instance of ContactSearchResponse', function() {
      // uncomment below and update the code to test ContactSearchResponse
      //var instance = new egoisdk.ContactSearchResponse();
      //expect(instance).to.be.a(egoisdk.ContactSearchResponse);
    });
