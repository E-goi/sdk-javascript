...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactUtmPostSchemaUtm();
  });
  ...
  describe('ContactUtmPostSchemaUtm', function() {
    it('should create an instance of ContactUtmPostSchemaUtm', function() {
      // uncomment below and update the code to test ContactUtmPostSchemaUtm
      //var instance = new egoisdk.ContactUtmPostSchemaUtm();
      //expect(instance).to.be.a(egoisdk.ContactUtmPostSchemaUtm);
    });
