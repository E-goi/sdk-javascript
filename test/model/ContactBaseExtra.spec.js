...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseExtra();
  });
  ...
  describe('ContactBaseExtra', function() {
    it('should create an instance of ContactBaseExtra', function() {
      // uncomment below and update the code to test ContactBaseExtra
      //var instance = new egoisdk.ContactBaseExtra();
      //expect(instance).to.be.a(egoisdk.ContactBaseExtra);
    });
