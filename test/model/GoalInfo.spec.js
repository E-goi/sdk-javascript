...
(function(root, factory) {
  ...
  describe('GoalInfo', function() {
    it('should create an instance of GoalInfo', function() {
      // uncomment below and update the code to test GoalInfo
      //var instance = new egoisdk.GoalInfo();
      //expect(instance).to.be.a(egoisdk.GoalInfo);
    });
