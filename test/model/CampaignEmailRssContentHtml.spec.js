...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignEmailRssContentHtml();
  });
  ...
  describe('CampaignEmailRssContentHtml', function() {
    it('should create an instance of CampaignEmailRssContentHtml', function() {
      // uncomment below and update the code to test CampaignEmailRssContentHtml
      //var instance = new egoisdk.CampaignEmailRssContentHtml();
      //expect(instance).to.be.a(egoisdk.CampaignEmailRssContentHtml);
    });
