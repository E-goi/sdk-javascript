...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactUtmPost();
  });
  ...
  describe('ContactUtmPost', function() {
    it('should create an instance of ContactUtmPost', function() {
      // uncomment below and update the code to test ContactUtmPost
      //var instance = new egoisdk.ContactUtmPost();
      //expect(instance).to.be.a(egoisdk.ContactUtmPost);
    });
