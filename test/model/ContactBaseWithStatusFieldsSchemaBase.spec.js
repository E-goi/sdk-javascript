...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseWithStatusFieldsSchemaBase();
  });
  ...
  describe('ContactBaseWithStatusFieldsSchemaBase', function() {
    it('should create an instance of ContactBaseWithStatusFieldsSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseWithStatusFieldsSchemaBase
      //var instance = new egoisdk.ContactBaseWithStatusFieldsSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseWithStatusFieldsSchemaBase);
    });
