...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.PushVersionsVersionsInner();
  });
  ...
  describe('PushVersionsVersionsInner', function() {
    it('should create an instance of PushVersionsVersionsInner', function() {
      // uncomment below and update the code to test PushVersionsVersionsInner
      //var instance = new egoisdk.PushVersionsVersionsInner();
      //expect(instance).to.be.a(egoisdk.PushVersionsVersionsInner);
    });
