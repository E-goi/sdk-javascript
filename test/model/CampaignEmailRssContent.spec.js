...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignEmailRssContent();
  });
  ...
  describe('CampaignEmailRssContent', function() {
    it('should create an instance of CampaignEmailRssContent', function() {
      // uncomment below and update the code to test CampaignEmailRssContent
      //var instance = new egoisdk.CampaignEmailRssContent();
      //expect(instance).to.be.a(egoisdk.CampaignEmailRssContent);
    });
