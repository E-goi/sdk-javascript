...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.PushStats();
  });
  ...
  describe('PushStats', function() {
    it('should create an instance of PushStats', function() {
      // uncomment below and update the code to test PushStats
      //var instance = new egoisdk.PushStats();
      //expect(instance).to.be.a(egoisdk.PushStats);
    });
