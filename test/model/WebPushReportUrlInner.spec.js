...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.WebPushReportUrlInner();
  });
  ...
  describe('WebPushReportUrlInner', function() {
    it('should create an instance of WebPushReportUrlInner', function() {
      // uncomment below and update the code to test WebPushReportUrlInner
      //var instance = new egoisdk.WebPushReportUrlInner();
      //expect(instance).to.be.a(egoisdk.WebPushReportUrlInner);
    });
