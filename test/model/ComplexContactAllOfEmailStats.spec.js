...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ComplexContactAllOfEmailStats();
  });
  ...
  describe('ComplexContactAllOfEmailStats', function() {
    it('should create an instance of ComplexContactAllOfEmailStats', function() {
      ...
      //var instance = new egoisdk.ComplexContactAllOfEmailStats();
      //expect(instance).to.be.a(egoisdk.ComplexContactAllOfEmailStats);
    });
