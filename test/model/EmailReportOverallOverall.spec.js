...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportOverallOverall();
  });
  ...
  describe('EmailReportOverallOverall', function() {
    it('should create an instance of EmailReportOverallOverall', function() {
      // uncomment below and update the code to test EmailReportOverallOverall
      //var instance = new egoisdk.EmailReportOverallOverall();
      //expect(instance).to.be.a(egoisdk.EmailReportOverallOverall);
    });
