...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.WebPushStats();
  });
  ...
  describe('WebPushStats', function() {
    it('should create an instance of WebPushStats', function() {
      // uncomment below and update the code to test WebPushStats
      //var instance = new egoisdk.WebPushStats();
      //expect(instance).to.be.a(egoisdk.WebPushStats);
    });
