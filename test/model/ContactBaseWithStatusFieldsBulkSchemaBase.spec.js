...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseWithStatusFieldsBulkSchemaBase();
  });
  ...
  describe('ContactBaseWithStatusFieldsBulkSchemaBase', function() {
    it('should create an instance of ContactBaseWithStatusFieldsBulkSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseWithStatusFieldsBulkSchemaBase
      //var instance = new egoisdk.ContactBaseWithStatusFieldsBulkSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseWithStatusFieldsBulkSchemaBase);
    });
