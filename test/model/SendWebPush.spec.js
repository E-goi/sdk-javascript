...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.SendWebPush();
  });
  ...
  describe('SendWebPush', function() {
    it('should create an instance of SendWebPush', function() {
      // uncomment below and update the code to test SendWebPush
      //var instance = new egoisdk.SendWebPush();
      //expect(instance).to.be.a(egoisdk.SendWebPush);
    });
