...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateEmailClicksByContactReport();
  });
  ...
  describe('GenerateEmailClicksByContactReport', function() {
    it('should create an instance of GenerateEmailClicksByContactReport', function() {
      // uncomment below and update the code to test GenerateEmailClicksByContactReport
      //var instance = new egoisdk.GenerateEmailClicksByContactReport();
      //expect(instance).to.be.a(egoisdk.GenerateEmailClicksByContactReport);
    });
