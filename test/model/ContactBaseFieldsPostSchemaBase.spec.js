...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseFieldsPostSchemaBase();
  });
  ...
  describe('ContactBaseFieldsPostSchemaBase', function() {
    it('should create an instance of ContactBaseFieldsPostSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseFieldsPostSchemaBase
      //var instance = new egoisdk.ContactBaseFieldsPostSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseFieldsPostSchemaBase);
    });
