...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateFormAnswersReport();
  });
  ...
  describe('GenerateFormAnswersReport', function() {
    it('should create an instance of GenerateFormAnswersReport', function() {
      // uncomment below and update the code to test GenerateFormAnswersReport
      //var instance = new egoisdk.GenerateFormAnswersReport();
      //expect(instance).to.be.a(egoisdk.GenerateFormAnswersReport);
    });
