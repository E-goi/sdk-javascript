...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.UnsubscriptionObject();
  });
  ...
  describe('UnsubscriptionObject', function() {
    it('should create an instance of UnsubscriptionObject', function() {
      // uncomment below and update the code to test UnsubscriptionObject
      //var instance = new egoisdk.UnsubscriptionObject();
      //expect(instance).to.be.a(egoisdk.UnsubscriptionObject);
    });
