...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactStatusFieldsSchema();
  });
  ...
  describe('ContactStatusFieldsSchema', function() {
    it('should create an instance of ContactStatusFieldsSchema', function() {
      // uncomment below and update the code to test ContactStatusFieldsSchema
      //var instance = new egoisdk.ContactStatusFieldsSchema();
      //expect(instance).to.be.a(egoisdk.ContactStatusFieldsSchema);
    });
