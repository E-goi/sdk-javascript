...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactExportRequest();
  });
  ...
  describe('ContactExportRequest', function() {
    it('should create an instance of ContactExportRequest', function() {
      // uncomment below and update the code to test ContactExportRequest
      //var instance = new egoisdk.ContactExportRequest();
      //expect(instance).to.be.a(egoisdk.ContactExportRequest);
    });
