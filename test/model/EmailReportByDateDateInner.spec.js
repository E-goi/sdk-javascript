...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByDateDateInner();
  });
  ...
  describe('EmailReportByDateDateInner', function() {
    it('should create an instance of EmailReportByDateDateInner', function() {
      // uncomment below and update the code to test EmailReportByDateDateInner
      //var instance = new egoisdk.EmailReportByDateDateInner();
      //expect(instance).to.be.a(egoisdk.EmailReportByDateDateInner);
    });
