...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByHourHourInner();
  });
  ...
  describe('EmailReportByHourHourInner', function() {
    it('should create an instance of EmailReportByHourHourInner', function() {
      // uncomment below and update the code to test EmailReportByHourHourInner
      //var instance = new egoisdk.EmailReportByHourHourInner();
      //expect(instance).to.be.a(egoisdk.EmailReportByHourHourInner);
    });
