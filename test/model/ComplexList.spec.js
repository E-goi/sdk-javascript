...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ComplexList();
  });
  ...
  describe('ComplexList', function() {
    it('should create an instance of ComplexList', function() {
      // uncomment below and update the code to test ComplexList
      //var instance = new egoisdk.ComplexList();
      //expect(instance).to.be.a(egoisdk.ComplexList);
    });
    ...
    it('should have the property availableLanguages (base name: "available_languages")', function() {
      // uncomment below and update the code to test the property availableLanguages
      //var instance = new egoisdk.ComplexList();
      //expect(instance).to.be();
    });
