...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignPushSendRequest();
  });
  ...
  describe('CampaignPushSendRequest', function() {
    it('should create an instance of CampaignPushSendRequest', function() {
      // uncomment below and update the code to test CampaignPushSendRequest
      //var instance = new egoisdk.CampaignPushSendRequest();
      //expect(instance).to.be.a(egoisdk.CampaignPushSendRequest);
    });
