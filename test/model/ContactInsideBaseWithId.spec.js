...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactInsideBaseWithId();
  });
  ...
  describe('ContactInsideBaseWithId', function() {
    it('should create an instance of ContactInsideBaseWithId', function() {
      // uncomment below and update the code to test ContactInsideBaseWithId
      //var instance = new egoisdk.ContactInsideBaseWithId();
      //expect(instance).to.be.a(egoisdk.ContactInsideBaseWithId);
    });
