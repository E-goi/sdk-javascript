...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReportByWeekdayWeekdayInner();
  });
  ...
  describe('EmailReportByWeekdayWeekdayInner', function() {
    it('should create an instance of EmailReportByWeekdayWeekdayInner', function() {
      // uncomment below and update the code to test EmailReportByWeekdayWeekdayInner
      //var instance = new egoisdk.EmailReportByWeekdayWeekdayInner();
      //expect(instance).to.be.a(egoisdk.EmailReportByWeekdayWeekdayInner);
    });
