...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignWebPushScheduleRequest();
  });
  ...
  describe('CampaignWebPushScheduleRequest', function() {
    it('should create an instance of CampaignWebPushScheduleRequest', function() {
      // uncomment below and update the code to test CampaignWebPushScheduleRequest
      //var instance = new egoisdk.CampaignWebPushScheduleRequest();
      //expect(instance).to.be.a(egoisdk.CampaignWebPushScheduleRequest);
    });
