...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoiSdk.WebPushReportBrowsers();
  });
  ...
  describe('WebPushReportBrowsers', function() {
    it('should create an instance of WebPushReportBrowsers', function() {
      // uncomment below and update the code to test WebPushReportBrowsers
      //var instance = new egoiSdk.WebPushReportBrowsers();
      //expect(instance).to.be.a(egoiSdk.WebPushReportBrowsers);
    });
