...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseWithStatusFieldsNoTokensSchemaBase();
  });
  ...
  describe('ContactBaseWithStatusFieldsNoTokensSchemaBase', function() {
    it('should create an instance of ContactBaseWithStatusFieldsNoTokensSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseWithStatusFieldsNoTokensSchemaBase
      //var instance = new egoisdk.ContactBaseWithStatusFieldsNoTokensSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseWithStatusFieldsNoTokensSchemaBase);
    });
