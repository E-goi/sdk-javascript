...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseExtraPost();
  });
  ...
  describe('ContactBaseExtraPost', function() {
    it('should create an instance of ContactBaseExtraPost', function() {
      // uncomment below and update the code to test ContactBaseExtraPost
      //var instance = new egoisdk.ContactBaseExtraPost();
      //expect(instance).to.be.a(egoisdk.ContactBaseExtraPost);
    });
