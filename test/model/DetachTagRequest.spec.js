...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.DetachTagRequest();
  });
  ...
  describe('DetachTagRequest', function() {
    it('should create an instance of DetachTagRequest', function() {
      // uncomment below and update the code to test DetachTagRequest
      //var instance = new egoisdk.DetachTagRequest();
      //expect(instance).to.be.a(egoisdk.DetachTagRequest);
    });
