...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignSmsScheduleRequest();
  });
  ...
  describe('CampaignSmsScheduleRequest', function() {
    it('should create an instance of CampaignSmsScheduleRequest', function() {
      // uncomment below and update the code to test CampaignSmsScheduleRequest
      //var instance = new egoisdk.CampaignSmsScheduleRequest();
      //expect(instance).to.be.a(egoisdk.CampaignSmsScheduleRequest);
    });
