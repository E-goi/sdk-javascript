...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.HeaderFooterTemplate();
  });
  ...
  describe('HeaderFooterTemplate', function() {
    it('should create an instance of HeaderFooterTemplate', function() {
      // uncomment below and update the code to test HeaderFooterTemplate
      //var instance = new egoisdk.HeaderFooterTemplate();
      //expect(instance).to.be.a(egoisdk.HeaderFooterTemplate);
    });
