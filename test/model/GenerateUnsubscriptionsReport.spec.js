...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateUnsubscriptionsReport();
  });
  ...
  describe('GenerateUnsubscriptionsReport', function() {
    it('should create an instance of GenerateUnsubscriptionsReport', function() {
      // uncomment below and update the code to test GenerateUnsubscriptionsReport
      //var instance = new egoisdk.GenerateUnsubscriptionsReport();
      //expect(instance).to.be.a(egoisdk.GenerateUnsubscriptionsReport);
    });
