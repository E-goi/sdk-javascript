...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignWebPushSendRequest();
  });
  ...
  describe('CampaignWebPushSendRequest', function() {
    it('should create an instance of CampaignWebPushSendRequest', function() {
      // uncomment below and update the code to test CampaignWebPushSendRequest
      //var instance = new egoisdk.CampaignWebPushSendRequest();
      //expect(instance).to.be.a(egoisdk.CampaignWebPushSendRequest);
    });
