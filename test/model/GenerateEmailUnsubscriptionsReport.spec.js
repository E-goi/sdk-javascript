...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.GenerateEmailUnsubscriptionsReport();
  });
  ...
  describe('GenerateEmailUnsubscriptionsReport', function() {
    it('should create an instance of GenerateEmailUnsubscriptionsReport', function() {
      // uncomment below and update the code to test GenerateEmailUnsubscriptionsReport
      //var instance = new egoisdk.GenerateEmailUnsubscriptionsReport();
      //expect(instance).to.be.a(egoisdk.GenerateEmailUnsubscriptionsReport);
    });
