...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.BasicProduct();
  });
  ...
  describe('BasicProduct', function() {
    it('should create an instance of BasicProduct', function() {
      // uncomment below and update the code to test BasicProduct
      //var instance = new egoisdk.BasicProduct();
      //expect(instance).to.be.a(egoisdk.BasicProduct);
    });
