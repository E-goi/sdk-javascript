...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.CampaignEmailContentTemplate();
  });
  ...
  describe('CampaignEmailContentTemplate', function() {
    it('should create an instance of CampaignEmailContentTemplate', function() {
      // uncomment below and update the code to test CampaignEmailContentTemplate
      //var instance = new egoisdk.CampaignEmailContentTemplate();
      //expect(instance).to.be.a(egoisdk.CampaignEmailContentTemplate);
    });
