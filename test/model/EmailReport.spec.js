...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.EmailReport();
  });
  ...
  describe('EmailReport', function() {
    it('should create an instance of EmailReport', function() {
      // uncomment below and update the code to test EmailReport
      //var instance = new egoisdk.EmailReport();
      //expect(instance).to.be.a(egoisdk.EmailReport);
    });
