...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new egoisdk.ContactBaseWithStatusNoRemovedFieldsSchemaBase();
  });
  ...
  describe('ContactBaseWithStatusNoRemovedFieldsSchemaBase', function() {
    it('should create an instance of ContactBaseWithStatusNoRemovedFieldsSchemaBase', function() {
      // uncomment below and update the code to test ContactBaseWithStatusNoRemovedFieldsSchemaBase
      //var instance = new egoisdk.ContactBaseWithStatusNoRemovedFieldsSchemaBase();
      //expect(instance).to.be.a(egoisdk.ContactBaseWithStatusNoRemovedFieldsSchemaBase);
    });
