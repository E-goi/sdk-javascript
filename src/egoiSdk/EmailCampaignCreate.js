...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/CampaignEmailContent', 'egoiSdk/HeaderFooter'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CampaignEmailContent'), require('./HeaderFooter'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.EmailCampaignCreate = factory(root.egoiSdk.ApiClient, root.egoiSdk.CampaignEmailContent, root.egoiSdk.HeaderFooter);
  }
}(this, function(ApiClient, CampaignEmailContent, HeaderFooter) {
  'use strict';
