...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/EmailSendSegment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EmailSendSegment'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.AbstractSendEmail = factory(root.egoiSdk.ApiClient, root.egoiSdk.EmailSendSegment);
  }
}(this, function(ApiClient, EmailSendSegment) {
  'use strict';
   ...
   * @return {Boolean}
   */
  exports.prototype.getUniqueContactsOnly = function() {
   ...
   */
  exports.prototype.setUniqueContactsOnly = function(uniqueContactsOnly) {
