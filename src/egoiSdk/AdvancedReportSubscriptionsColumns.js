...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/SubscriptionsListStatsFields'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SubscriptionsListStatsFields'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.AdvancedReportSubscriptionsColumns = factory(root.egoiSdk.ApiClient, root.egoiSdk.SubscriptionsListStatsFields);
  }
}(this, function(ApiClient, SubscriptionsListStatsFields) {
  'use strict';
   ...
   */
  var exports = function(listBaseFields, listExtraFields, listStatsFields) {
    var _this = this;
