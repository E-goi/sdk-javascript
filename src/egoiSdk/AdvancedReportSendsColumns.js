...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/SendsCampaignFields'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SendsCampaignFields'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.AdvancedReportSendsColumns = factory(root.egoiSdk.ApiClient, root.egoiSdk.SendsCampaignFields);
  }
}(this, function(ApiClient, SendsCampaignFields) {
  'use strict';
   ...
   */
  var exports = function(listBaseFields, listExtraFields, campaignFields) {
    var _this = this;
