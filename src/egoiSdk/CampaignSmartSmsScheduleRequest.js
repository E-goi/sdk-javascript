...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/LimitHourActionSendLimitHour', 'egoiSdk/SendSmartSms', 'egoiSdk/SmartSmsSegmentsActionSend'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LimitHourActionSendLimitHour'), require('./SendSmartSms'), require('./SmartSmsSegmentsActionSend'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.CampaignSmartSmsScheduleRequest = factory(root.egoiSdk.ApiClient, root.egoiSdk.LimitHourActionSendLimitHour, root.egoiSdk.SendSmartSms, root.egoiSdk.SmartSmsSegmentsActionSend);
  }
}(this, function(ApiClient, LimitHourActionSendLimitHour, SendSmartSms, SmartSmsSegmentsActionSend) {
  'use strict';
