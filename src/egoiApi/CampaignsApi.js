...
export default class CampaignsApi {
    ...
    */
     ...
     */
    deleteCampaigns(campaignHash, callback) {
      let postBody = null;
     ...
     * @param {Number} opts.limit Number of items to return (default to 100)
    ...
    getAllCampaigns(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CampaignsCollection;
      return this.apiClient.callApi(
        '/campaigns', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
