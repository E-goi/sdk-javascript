...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/Forbidden', 'egoiSdk/InternalServerError', 'egoiSdk/ServiceUnavailable', 'egoiSdk/SuppressionListItems', 'egoiSdk/TooManyRequests', 'egoiSdk/Unauthorized', 'egoiSdk/UnprocessableEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../egoiSdk/Forbidden'), require('../egoiSdk/InternalServerError'), require('../egoiSdk/ServiceUnavailable'), require('../egoiSdk/SuppressionListItems'), require('../egoiSdk/TooManyRequests'), require('../egoiSdk/Unauthorized'), require('../egoiSdk/UnprocessableEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.SuppressionListApi = factory(root.egoiSdk.ApiClient, root.egoiSdk.Forbidden, root.egoiSdk.InternalServerError, root.egoiSdk.ServiceUnavailable, root.egoiSdk.SuppressionListItems, root.egoiSdk.TooManyRequests, root.egoiSdk.Unauthorized, root.egoiSdk.UnprocessableEntity);
  }
}(this, function(ApiClient, Forbidden, InternalServerError, ServiceUnavailable, SuppressionListItems, TooManyRequests, Unauthorized, UnprocessableEntity) {
  'use strict';
