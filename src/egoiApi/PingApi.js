...
export default class PingApi {
    ...
    */
     ...
     * @callback module:egoiApi/PingApi~pingCallback
     * @param {String} error Error message, if any.
     * @param {module:egoisdk/Ping} data The data returned by the service call.
     ...
     * @param {module:egoiApi/PingApi~pingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:egoisdk/Ping}
     */
    ping(callback) {
      let postBody = null;
