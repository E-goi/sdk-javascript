...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'egoiSdk/BadRequest', 'egoiSdk/DeleteFieldsConflict', 'egoiSdk/Field', 'egoiSdk/FieldCollection', 'egoiSdk/FieldOption', 'egoiSdk/FieldOptionsCollection', 'egoiSdk/Forbidden', 'egoiSdk/InternalServerError', 'egoiSdk/NotFound', 'egoiSdk/PatchRequestBaseField', 'egoiSdk/PatchRequestField', 'egoiSdk/Unauthorized', 'egoiSdk/UnprocessableEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../egoiSdk/BadRequest'), require('../egoiSdk/DeleteFieldsConflict'), require('../egoiSdk/Field'), require('../egoiSdk/FieldCollection'), require('../egoiSdk/FieldOption'), require('../egoiSdk/FieldOptionsCollection'), require('../egoiSdk/Forbidden'), require('../egoiSdk/InternalServerError'), require('../egoiSdk/NotFound'), require('../egoiSdk/PatchRequestBaseField'), require('../egoiSdk/PatchRequestField'), require('../egoiSdk/Unauthorized'), require('../egoiSdk/UnprocessableEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.egoiSdk) {
      root.egoiSdk = {};
    }
    root.egoiSdk.FieldsApi = factory(root.egoiSdk.ApiClient, root.egoiSdk.BadRequest, root.egoiSdk.DeleteFieldsConflict, root.egoiSdk.Field, root.egoiSdk.FieldCollection, root.egoiSdk.FieldOption, root.egoiSdk.FieldOptionsCollection, root.egoiSdk.Forbidden, root.egoiSdk.InternalServerError, root.egoiSdk.NotFound, root.egoiSdk.PatchRequestBaseField, root.egoiSdk.PatchRequestField, root.egoiSdk.Unauthorized, root.egoiSdk.UnprocessableEntity);
  }
}(this, function(ApiClient, BadRequest, DeleteFieldsConflict, Field, FieldCollection, FieldOption, FieldOptionsCollection, Forbidden, InternalServerError, NotFound, PatchRequestBaseField, PatchRequestField, Unauthorized, UnprocessableEntity) {
  'use strict';
