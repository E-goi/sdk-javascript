...
export default class CNamesApi {
    ...
    */
     ...
     * Create cname
     * Creates a cnames
     * @param {module:egoisdk/CNamePost} cNamePost Parameters for the cname
     ...
     */
    createCName(cNamePost, callback) {
      let postBody = cNamePost;
      // verify the required parameter 'cNamePost' is set
      if (cNamePost === undefined || cNamePost === null) {
        throw new Error("Missing the required parameter 'cNamePost' when calling createCName");
      }
    ...
    getAllCNames(callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CNamesCollection;
      return this.apiClient.callApi(
        '/cnames', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
