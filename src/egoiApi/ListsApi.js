...
export default class ListsApi {
    ...
    */
     ...
     * @callback module:egoiApi/ListsApi~getListCallback
     * @param {String} error Error message, if any.
     * @param {module:egoisdk/ComplexList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} listId ID of the List
     * @param {module:egoiApi/ListsApi~getListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:egoisdk/ComplexList}
     */
