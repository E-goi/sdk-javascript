...
import PhoneCampaignTemplateAllOf from './PhoneCampaignTemplateAllOf';
...
class PhoneCampaignTemplate {
     ...
     * @implements module:egoisdk/PhoneCampaignTemplateAllOf
     * @implements module:egoisdk/AbstractCampaignTemplate
     */
    constructor() { 
        PhoneCampaignTemplateAllOf.initialize(this);AbstractCampaignTemplate.initialize(this);
        PhoneCampaignTemplate.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneCampaignTemplate();
            PhoneCampaignTemplateAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneCampaignTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneCampaignTemplate</code>.
     */
...
// Implement PhoneCampaignTemplateAllOf interface:
/**
 * Message
 * @member {String} message
 */
PhoneCampaignTemplateAllOf.prototype['message'] = undefined;
/**
 * Sender number
 * @member {String} sender
 */
PhoneCampaignTemplateAllOf.prototype['sender'] = undefined;
/**
 * Message type
 * @member {module:egoisdk/PhoneCampaignTemplateAllOf.MessageTypeEnum} message_type
 */
PhoneCampaignTemplateAllOf.prototype['message_type'] = undefined;
 ...
 * @readonly
 */
PhoneCampaignTemplate['MessageTypeEnum'] = {
...
export default PhoneCampaignTemplate;
