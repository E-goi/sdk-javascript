...
import SendSmartSmsAllOf1 from './SendSmartSmsAllOf1';
import SendSmartSmsAllOf2 from './SendSmartSmsAllOf2';
...
class SendSmartSms {
    /**
     * Constructs a new <code>SendSmartSms</code>.
     * @alias module:egoisdk/SendSmartSms
     * @implements module:egoisdk/SendSmartSmsAllOf
     * @implements module:egoisdk/SendSmartSmsAllOf1
     * @implements module:egoisdk/SendSmartSmsAllOf2
    ...
    constructor(listId, destinationField, segments) { 
        SendSmartSmsAllOf.initialize(this);SendSmartSmsAllOf1.initialize(this);SendSmartSmsAllOf2.initialize(this);LimitHourActionSend.initialize(this);NotifyUserIdArrayActionSend.initialize(this);
        SendSmartSms.initialize(this, listId, destinationField, segments);
    }
    ...
    /**
     * Constructs a <code>SendSmartSms</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/SendSmartSms} obj Optional instance to populate.
     * @return {module:egoisdk/SendSmartSms} The populated <code>SendSmartSms</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendSmartSms();
            SendSmartSmsAllOf.constructFromObject(data, obj);
            SendSmartSmsAllOf1.constructFromObject(data, obj);
            SendSmartSmsAllOf2.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SendSmartSms</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendSmartSms</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SendSmartSms.RequiredProperties) {
            if (!data[property]) {
...
SendSmartSms.RequiredProperties = ["list_id", "destination_field", "segments"];
...
// Implement SendSmartSmsAllOf1 interface:
/**
 * Smart SMS campaign destination field. Must be 'cellphone' or the other field ID of type                                 cellphone
 * @member {String} destination_field
 */
SendSmartSmsAllOf1.prototype['destination_field'] = undefined;
// Implement SendSmartSmsAllOf2 interface:
/**
 * @member {module:egoisdk/SmartSmsSegmentsActionSend} segments
 */
SendSmartSmsAllOf2.prototype['segments'] = undefined;
