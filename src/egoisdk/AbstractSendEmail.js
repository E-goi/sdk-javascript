...
/**
 * The AbstractSendEmail model module.
 * @module egoisdk/AbstractSendEmail
 * @version 1.1.6RC1
 */
class AbstractSendEmail {
    /**
     * Constructs a new <code>AbstractSendEmail</code>.
     * Campaign email abstract schema
     * @alias module:egoisdk/AbstractSendEmail
     * @param listId {Number} 
     * @param segments {module:egoisdk/EmailSendSegment} 
     */
    constructor(listId, segments) { 
        
        AbstractSendEmail.initialize(this, listId, segments);
    }
    ...
    /**
     * Constructs a <code>AbstractSendEmail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/AbstractSendEmail} obj Optional instance to populate.
     * @return {module:egoisdk/AbstractSendEmail} The populated <code>AbstractSendEmail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AbstractSendEmail();
    ...
    /**
     * Validates the JSON data with respect to <code>AbstractSendEmail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbstractSendEmail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AbstractSendEmail.RequiredProperties) {
            if (!data[property]) {
...
AbstractSendEmail.RequiredProperties = ["list_id", "segments"];
...
export default AbstractSendEmail;
