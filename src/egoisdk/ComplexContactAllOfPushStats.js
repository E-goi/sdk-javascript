 ...
 * @module egoisdk/ComplexContactAllOfPushStats
 * @version 1.1.3RC1
 */
class ComplexContactAllOfPushStats {
     ...
     * @alias module:egoisdk/ComplexContactAllOfPushStats
     */
    constructor() { 
     ...
     * @param {module:egoisdk/ComplexContactAllOfPushStats} obj Optional instance to populate.
     * @return {module:egoisdk/ComplexContactAllOfPushStats} The populated <code>ComplexContactAllOfPushStats</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ComplexContactAllOfPushStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComplexContactAllOfPushStats</code>.
     */
