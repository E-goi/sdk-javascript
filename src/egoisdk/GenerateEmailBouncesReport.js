...
class GenerateEmailBouncesReport {
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateEmailBouncesReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateEmailBouncesReport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateEmailBouncesReport.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['columns']) { // data not null
          AdvancedReportEmailBouncesColumns.validateJSON(data['columns']);
        }
        // validate the optional field `options`
        if (data['options']) { // data not null
          AdvancedReportEmailBouncesOptions.validateJSON(data['options']);
        }
        // ensure the json data is a string
...
GenerateEmailBouncesReport.RequiredProperties = ["title", "range", "campaigns", "columns", "options"];
 ...
 */
GenerateEmailBouncesReport.prototype['callback_url'] = undefined;
