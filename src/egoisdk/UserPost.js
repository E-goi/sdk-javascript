...
class UserPost {
     ...
     * User schema
     * @alias module:egoisdk/UserPost
     * @implements module:egoisdk/UserPostAllOf
     */
    constructor() { 
     ...
     * @param {module:egoisdk/UserPost} obj Optional instance to populate.
     * @return {module:egoisdk/UserPost} The populated <code>UserPost</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>UserPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPost</code>.
     */
