...
class AbstractCellphoneSender {
     ...
     * @param type {module:egoisdk/AbstractCellphoneSender.TypeEnum} Sender code type
     * @param senderId {Number} 
     */
    constructor(type, senderId) { 
        AbstractCellphoneSenderAllOf.initialize(this);BasicSender.initialize(this, senderId);
        AbstractCellphoneSender.initialize(this, type, senderId);
    }
     ...
     */
    static initialize(obj, type, senderId) { 
        obj['type'] = type;
    ...
    /**
     * Validates the JSON data with respect to <code>AbstractCellphoneSender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbstractCellphoneSender</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AbstractCellphoneSender.RequiredProperties) {
            if (!data[property]) {
...
/**
     ...
     * @return {module:egoisdk/AbstractCellphoneSender.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/AbstractCellphoneSender.StatusEnum} status Status of the sender
     */
    setStatus(status) {
        this['status'] = status;
    }
...
AbstractCellphoneSender.RequiredProperties = ["type", "sender_id"];
