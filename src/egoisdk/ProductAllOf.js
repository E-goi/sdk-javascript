...
class ProductAllOf {
     ...
     * @alias module:egoisdk/ProductAllOf
     */
    constructor() { 
     ...
     * @param {module:egoisdk/ProductAllOf} obj Optional instance to populate.
     * @return {module:egoisdk/ProductAllOf} The populated <code>ProductAllOf</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ProductAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductAllOf</code>.
     */
