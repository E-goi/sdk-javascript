...
class CreateOrder {
    ...
    constructor(orderId) { 
        ...
        CreateOrder.initialize(this, orderId);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateOrder</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateOrder.RequiredProperties) {
            if (!data[property]) {
...
/**
    ...
    /**
     * @param {module:egoisdk/Contact1} contact
     */
    setContact(contact) {
...
CreateOrder.RequiredProperties = ["order_id"];

/**
 * Ecommerce cart total
 * @member {Number} order_total
 */
CreateOrder.prototype['order_total'] = undefined;

/**
 * Order ID is any non-empty unique string
 * @member {String} order_id
 */
CreateOrder.prototype['order_id'] = undefined;
