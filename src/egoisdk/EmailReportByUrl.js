...
class EmailReportByUrl {
    /**
     * Constructs a new <code>EmailReportByUrl</code>.
     * Email stats grouped by Url
     * @alias module:egoisdk/EmailReportByUrl
     */
    constructor() { 
        
        EmailReportByUrl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByUrl} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByUrl} The populated <code>EmailReportByUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByUrl</code>.
     */
...
export default EmailReportByUrl;
