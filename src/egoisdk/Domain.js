...
class Domain {
     ...
     * @param {module:egoisdk/Domain} obj Optional instance to populate.
     * @return {module:egoisdk/Domain} The populated <code>Domain</code> instance.
     */
...
/**
     ...
     * @return {module:egoisdk/Domain.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * Sets Domain status
     * @param {module:egoisdk/Domain.StatusEnum} status Domain status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 */
Domain.prototype['list_id'] = undefined;

/**
 * Domain status
 * @member {module:egoisdk/Domain.StatusEnum} status
 */
