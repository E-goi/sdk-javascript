...
/**
 * The ContactUtmPost model module.
 * @module egoisdk/ContactUtmPost
 * @version 1.1.6RC1
 */
class ContactUtmPost {
    /**
     * Constructs a new <code>ContactUtmPost</code>.
     * @alias module:egoisdk/ContactUtmPost
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ContactUtmPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactUtmPost} obj Optional instance to populate.
     * @return {module:egoisdk/ContactUtmPost} The populated <code>ContactUtmPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactUtmPost();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactUtmPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactUtmPost</code>.
     */
