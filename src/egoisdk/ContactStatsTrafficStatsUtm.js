...
/**
 * The ContactStatsTrafficStatsUtm model module.
 * @module egoisdk/ContactStatsTrafficStatsUtm
 * @version 1.1.6RC1
 */
class ContactStatsTrafficStatsUtm {
    /**
     * Constructs a new <code>ContactStatsTrafficStatsUtm</code>.
     * Voice campaigns sent to the contact
     * @alias module:egoisdk/ContactStatsTrafficStatsUtm
     */
    constructor() { 
        
        ContactStatsTrafficStatsUtm.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactStatsTrafficStatsUtm</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactStatsTrafficStatsUtm} obj Optional instance to populate.
     * @return {module:egoisdk/ContactStatsTrafficStatsUtm} The populated <code>ContactStatsTrafficStatsUtm</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactStatsTrafficStatsUtm();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactStatsTrafficStatsUtm</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactStatsTrafficStatsUtm</code>.
     */
 ...
 */
ContactStatsTrafficStatsUtm.prototype['utm_source'] = undefined;

/**
 * Utm medium value
 * @member {String} utm_medium
 */
ContactStatsTrafficStatsUtm.prototype['utm_medium'] = undefined;

/**
 * Utm campaign value
 * @member {String} utm_campaign
 */
ContactStatsTrafficStatsUtm.prototype['utm_campaign'] = undefined;

/**
 * Utm content value
 * @member {String} utm_content
 */
ContactStatsTrafficStatsUtm.prototype['utm_content'] = undefined;

/**
 * Utm source value
 * @member {String} utm_term
 */
ContactStatsTrafficStatsUtm.prototype['utm_term'] = undefined;
...
export default ContactStatsTrafficStatsUtm;
