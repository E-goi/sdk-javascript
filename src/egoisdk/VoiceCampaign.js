...
class VoiceCampaign {
     ...
     * @alias module:egoisdk/VoiceCampaign
     * @implements module:egoisdk/VoiceCampaignAllOf
     * @param internalName {String} Voice campaign internal name
     * @param listId {Number} 
     * @param content {module:egoisdk/ContentVoice} 
     ...
     * @param {module:egoisdk/VoiceCampaign} obj Optional instance to populate.
     * @return {module:egoisdk/VoiceCampaign} The populated <code>VoiceCampaign</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ContentVoice.constructFromObject(data['content']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VoiceCampaign</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoiceCampaign</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VoiceCampaign.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['content']) { // data not null
          ContentVoice.validateJSON(data['content']);
        }
...
/**
     * @return {module:egoisdk/ContentVoice}
     */
    getContent() {
        return this.content;
    }
    ...
    /**
     * @param {module:egoisdk/ContentVoice} content
     */
    setContent(content) {
...
VoiceCampaign.RequiredProperties = ["internal_name", "list_id", "content", "sender_id"];

/**
 * Voice campaign internal name
 * @member {String} internal_name
 */
VoiceCampaign.prototype['internal_name'] = undefined;

/**
 * @member {Number} list_id
 */
VoiceCampaign.prototype['list_id'] = undefined;

/**
 * @member {Number} group_id
 */
VoiceCampaign.prototype['group_id'] = undefined;

/**
 * @member {module:egoisdk/ContentVoice} content
 */
VoiceCampaign.prototype['content'] = undefined;

/**
 * @member {Number} sender_id
 */
VoiceCampaign.prototype['sender_id'] = undefined;
