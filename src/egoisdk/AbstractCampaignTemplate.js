...
class AbstractCampaignTemplate {
    ...
    constructor() { 
        ...
        AbstractCampaignTemplate.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AbstractCampaignTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>AbstractCampaignTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbstractCampaignTemplate</code>.
     */
...
export default AbstractCampaignTemplate;
