...
class EmailReportByDomain {
    /**
     * Constructs a new <code>EmailReportByDomain</code>.
     * Email stats grouped by Domain
     * @alias module:egoisdk/EmailReportByDomain
     */
    constructor() { 
        
        EmailReportByDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByDomain} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByDomain} The populated <code>EmailReportByDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByDomain();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByDomain</code>.
     */
...
export default EmailReportByDomain;
