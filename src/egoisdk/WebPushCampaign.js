...
class WebPushCampaign {
    ...
    /**
     * Validates the JSON data with respect to <code>WebPushCampaign</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebPushCampaign</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebPushCampaign.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['content']) { // data not null
          MessageWebPushPost.validateJSON(data['content']);
        }
...
WebPushCampaign.RequiredProperties = ["site_id", "internal_name", "content"];
