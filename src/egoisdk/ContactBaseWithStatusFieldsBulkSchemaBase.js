...
/**
 * The ContactBaseWithStatusFieldsBulkSchemaBase model module.
 * @module egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase
 * @version 1.1.6RC1
 */
class ContactBaseWithStatusFieldsBulkSchemaBase {
    /**
     * Constructs a new <code>ContactBaseWithStatusFieldsBulkSchemaBase</code>.
     * Contact base fields
     * @alias module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase
     */
    constructor() { 
        
        ContactBaseWithStatusFieldsBulkSchemaBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactBaseWithStatusFieldsBulkSchemaBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase} obj Optional instance to populate.
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase} The populated <code>ContactBaseWithStatusFieldsBulkSchemaBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactBaseWithStatusFieldsBulkSchemaBase();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactBaseWithStatusFieldsBulkSchemaBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactBaseWithStatusFieldsBulkSchemaBase</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.StatusEnum} status Status of the contact
     */
    setStatus(status) {
        this['status'] = status;
    }
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.ConsentEnum}
     */
    getConsent() {
        return this.consent;
    }
     ...
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.ConsentEnum} consent Contact consent
     */
    setConsent(consent) {
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.EmailStatusEnum}
     */
    getEmailStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.EmailStatusEnum} emailStatus Email channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.CellphoneStatusEnum}
     */
    getCellphoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.CellphoneStatusEnum} cellphoneStatus Cellphone channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.PhoneStatusEnum}
     */
    getPhoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.PhoneStatusEnum} phoneStatus Phone channel status
     */
 ...
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['contact_id'] = undefined;

/**
 * Status of the contact
 * @member {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.StatusEnum} status
 * @default 'active'
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['status'] = 'active';

/**
 * Contact consent
 * @member {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.ConsentEnum} consent
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['consent'] = undefined;

/**
 * First name of the contact
 * @member {String} first_name
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['first_name'] = undefined;

/**
 * Last name of the contact
 * @member {String} last_name
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['last_name'] = undefined;

/**
 * Birth date of the contact
 * @member {Date} birth_date
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['birth_date'] = undefined;

/**
 * @member {module:egoisdk/Language} language
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['language'] = undefined;

/**
 * Email of the contact
 * @member {String} email
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['email'] = undefined;

/**
 * Email channel status
 * @member {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.EmailStatusEnum} email_status
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['email_status'] = undefined;

/**
 * Cellphone of the contact
 * @member {String} cellphone
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['cellphone'] = undefined;

/**
 * Cellphone channel status
 * @member {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.CellphoneStatusEnum} cellphone_status
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['cellphone_status'] = undefined;

/**
 * Phone of the contact
 * @member {String} phone
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['phone'] = undefined;

/**
 * Phone channel status
 * @member {module:egoisdk/ContactBaseWithStatusFieldsBulkSchemaBase.PhoneStatusEnum} phone_status
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['phone_status'] = undefined;
 ...
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['push_token_android'] = undefined;
 ...
 */
ContactBaseWithStatusFieldsBulkSchemaBase.prototype['push_token_ios'] = undefined;
 ...
 * @readonly
 */
ContactBaseWithStatusFieldsBulkSchemaBase['StatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusFieldsBulkSchemaBase['ConsentEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusFieldsBulkSchemaBase['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusFieldsBulkSchemaBase['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusFieldsBulkSchemaBase['PhoneStatusEnum'] = {
...
export default ContactBaseWithStatusFieldsBulkSchemaBase;
