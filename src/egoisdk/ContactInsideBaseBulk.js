...
class ContactInsideBaseBulk {
    /**
     * Constructs a new <code>ContactInsideBaseBulk</code>.
     * @alias module:egoisdk/ContactInsideBaseBulk
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ContactInsideBaseBulk</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactInsideBaseBulk} obj Optional instance to populate.
     * @return {module:egoisdk/ContactInsideBaseBulk} The populated <code>ContactInsideBaseBulk</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactInsideBaseBulk();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactInsideBaseBulk</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactInsideBaseBulk</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.StatusEnum} status Status of the contact
     */
    setStatus(status) {
        this['status'] = status;
    }
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.ConsentEnum}
     */
    getConsent() {
        return this.consent;
    }
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.ConsentEnum} consent Contact consent
     */
    setConsent(consent) {
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.SubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.SubscriptionMethodEnum} subscriptionMethod Contact subscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.UnsubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.UnsubscriptionMethodEnum} unsubscriptionMethod Contact unsubscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.UnsubscriptionReasonEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.UnsubscriptionReasonEnum} unsubscriptionReason Contact unsubscription reason
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.EmailStatusEnum}
     */
    getEmailStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.EmailStatusEnum} emailStatus Email channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.CellphoneStatusEnum}
     */
    getCellphoneStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.CellphoneStatusEnum} cellphoneStatus Cellphone channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseBulk.PhoneStatusEnum}
     */
    getPhoneStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseBulk.PhoneStatusEnum} phoneStatus Phone channel status
     */
 ...
 * @readonly
 */
ContactInsideBaseBulk['StatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['ConsentEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['SubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['UnsubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['UnsubscriptionReasonEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseBulk['PhoneStatusEnum'] = {
...
export default ContactInsideBaseBulk;
