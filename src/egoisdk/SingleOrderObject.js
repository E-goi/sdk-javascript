...
/**
 * The SingleOrderObject model module.
 * @module egoisdk/SingleOrderObject
 * @version 1.1.6RC1
 */
class SingleOrderObject {
    /**
     * Constructs a new <code>SingleOrderObject</code>.
     * Single Order data
     * @alias module:egoisdk/SingleOrderObject
     ...
     */
    constructor(orderId, revenue, storeUrl, items) { 
        
        SingleOrderObject.initialize(this, orderId, revenue, storeUrl, items);
    }
     ...
     */
    static initialize(obj, orderId, revenue, storeUrl, items) { 
    ...
    /**
     * Constructs a <code>SingleOrderObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/SingleOrderObject} obj Optional instance to populate.
     * @return {module:egoisdk/SingleOrderObject} The populated <code>SingleOrderObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SingleOrderObject();
    ...
    /**
     * Validates the JSON data with respect to <code>SingleOrderObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SingleOrderObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SingleOrderObject.RequiredProperties) {
            if (!data[property]) {
...
SingleOrderObject.RequiredProperties = ["order_id", "revenue", "store_url", "items"];

/**
 * Ecommerce order id
 * @member {String} order_id
 */
SingleOrderObject.prototype['order_id'] = undefined;

/**
 * Ecommerce order revenue
 * @member {Number} revenue
 */
SingleOrderObject.prototype['revenue'] = undefined;

/**
 * Ecommerce store url
 * @member {String} store_url
 */
SingleOrderObject.prototype['store_url'] = undefined;

/**
 * Array of ordered products
 * @member {Array.<module:egoisdk/ImportOrdersBulkBulkRequestItems>} items
 */
SingleOrderObject.prototype['items'] = undefined;
...
export default SingleOrderObject;
