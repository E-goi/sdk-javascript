...
import ContactInsideBaseWithId from './ContactInsideBaseWithId';
...
class ContactBaseFieldsWithIdSchemaBase {
    /**
     * Constructs a new <code>ContactBaseFieldsWithIdSchemaBase</code>.
     * Contact base fields with contact_id
     * @alias module:egoisdk/ContactBaseFieldsWithIdSchemaBase
     * @implements module:egoisdk/ContactInsideBaseWithId
     */
    constructor() { 
        ContactInsideBaseWithId.initialize(this);
        ContactBaseFieldsWithIdSchemaBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactBaseFieldsWithIdSchemaBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase} obj Optional instance to populate.
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase} The populated <code>ContactBaseFieldsWithIdSchemaBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactBaseFieldsWithIdSchemaBase();
            ContactInsideBaseWithId.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ContactBaseFieldsWithIdSchemaBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactBaseFieldsWithIdSchemaBase</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.StatusEnum} status Status of the contact
     */
    setStatus(status) {
        this['status'] = status;
    }
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.ConsentEnum}
     */
    getConsent() {
        return this.consent;
    }
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.ConsentEnum} consent Contact consent
     */
    setConsent(consent) {
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.SubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.SubscriptionMethodEnum} subscriptionMethod Contact subscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionMethodEnum} unsubscriptionMethod Contact unsubscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionReasonEnum}
     */
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionReasonEnum} unsubscriptionReason Contact unsubscription reason
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.EmailStatusEnum}
     */
    getEmailStatus() {
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.EmailStatusEnum} emailStatus Email channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.CellphoneStatusEnum}
     */
    getCellphoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.CellphoneStatusEnum} cellphoneStatus Cellphone channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.PhoneStatusEnum}
     */
    getPhoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.PhoneStatusEnum} phoneStatus Phone channel status
     */
 ...
 */
ContactBaseFieldsWithIdSchemaBase.prototype['contact_id'] = undefined;

/**
 * Status of the contact
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.StatusEnum} status
 * @default 'active'
 */
ContactBaseFieldsWithIdSchemaBase.prototype['status'] = 'active';

/**
 * Contact consent
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.ConsentEnum} consent
 * @default 'consent'
 */
ContactBaseFieldsWithIdSchemaBase.prototype['consent'] = 'consent';

/**
 * Date and hour of the contact consent
 * @member {Date} consent_date
 */
ContactBaseFieldsWithIdSchemaBase.prototype['consent_date'] = undefined;

/**
 * Contact subscription method
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.SubscriptionMethodEnum} subscription_method
 */
ContactBaseFieldsWithIdSchemaBase.prototype['subscription_method'] = undefined;

/**
 * Date and hour of the contact subscription
 * @member {Date} subscription_date
 */
ContactBaseFieldsWithIdSchemaBase.prototype['subscription_date'] = undefined;

/**
 * Contact subscription form
 * @member {Number} subscription_form
 */
ContactBaseFieldsWithIdSchemaBase.prototype['subscription_form'] = undefined;

/**
 * Contact unsubscription method
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionMethodEnum} unsubscription_method
 */
ContactBaseFieldsWithIdSchemaBase.prototype['unsubscription_method'] = undefined;

/**
 * Contact unsubscription reason
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.UnsubscriptionReasonEnum} unsubscription_reason
 */
ContactBaseFieldsWithIdSchemaBase.prototype['unsubscription_reason'] = undefined;

/**
 * Contact unsubscription observation
 * @member {String} unsubscription_observation
 */
ContactBaseFieldsWithIdSchemaBase.prototype['unsubscription_observation'] = undefined;

/**
 * Contact unsubscription date
 * @member {Date} unsubscription_date
 */
ContactBaseFieldsWithIdSchemaBase.prototype['unsubscription_date'] = undefined;

/**
 * Last modification date of the contact
 * @member {Date} change_date
 */
ContactBaseFieldsWithIdSchemaBase.prototype['change_date'] = undefined;

/**
 * First name of the contact
 * @member {String} first_name
 */
ContactBaseFieldsWithIdSchemaBase.prototype['first_name'] = undefined;

/**
 * Last name of the contact
 * @member {String} last_name
 */
ContactBaseFieldsWithIdSchemaBase.prototype['last_name'] = undefined;

/**
 * Birth date of the contact
 * @member {Date} birth_date
 */
ContactBaseFieldsWithIdSchemaBase.prototype['birth_date'] = undefined;

/**
 * @member {module:egoisdk/Language} language
 */
ContactBaseFieldsWithIdSchemaBase.prototype['language'] = undefined;

/**
 * Email of the contact
 * @member {String} email
 */
ContactBaseFieldsWithIdSchemaBase.prototype['email'] = undefined;

/**
 * Email channel status
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.EmailStatusEnum} email_status
 * @default 'active'
 */
ContactBaseFieldsWithIdSchemaBase.prototype['email_status'] = 'active';

/**
 * Cellphone of the contact
 * @member {String} cellphone
 */
ContactBaseFieldsWithIdSchemaBase.prototype['cellphone'] = undefined;

/**
 * Cellphone channel status
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.CellphoneStatusEnum} cellphone_status
 * @default 'active'
 */
ContactBaseFieldsWithIdSchemaBase.prototype['cellphone_status'] = 'active';

/**
 * Phone of the contact
 * @member {String} phone
 */
ContactBaseFieldsWithIdSchemaBase.prototype['phone'] = undefined;

/**
 * Phone channel status
 * @member {module:egoisdk/ContactBaseFieldsWithIdSchemaBase.PhoneStatusEnum} phone_status
 * @default 'active'
 */
ContactBaseFieldsWithIdSchemaBase.prototype['phone_status'] = 'active';
 ...
 */
ContactBaseFieldsWithIdSchemaBase.prototype['push_token_android'] = undefined;
 ...
 */
ContactBaseFieldsWithIdSchemaBase.prototype['push_token_ios'] = undefined;


// Implement ContactInsideBaseWithId interface:
/**
 * @member {String} contact_id
 */
ContactInsideBaseWithId.prototype['contact_id'] = undefined;
/**
 * Status of the contact
 * @member {module:egoisdk/ContactInsideBaseWithId.StatusEnum} status
 * @default 'active'
 */
ContactInsideBaseWithId.prototype['status'] = 'active';
/**
 * Contact consent
 * @member {module:egoisdk/ContactInsideBaseWithId.ConsentEnum} consent
 * @default 'consent'
 */
ContactInsideBaseWithId.prototype['consent'] = 'consent';
/**
 * Date and hour of the contact consent
 * @member {Date} consent_date
 */
ContactInsideBaseWithId.prototype['consent_date'] = undefined;
/**
 * Contact subscription method
 * @member {module:egoisdk/ContactInsideBaseWithId.SubscriptionMethodEnum} subscription_method
 */
ContactInsideBaseWithId.prototype['subscription_method'] = undefined;
/**
 * Date and hour of the contact subscription
 * @member {Date} subscription_date
 */
ContactInsideBaseWithId.prototype['subscription_date'] = undefined;
/**
 * Contact subscription form
 * @member {Number} subscription_form
 */
ContactInsideBaseWithId.prototype['subscription_form'] = undefined;
/**
 * Contact unsubscription method
 * @member {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionMethodEnum} unsubscription_method
 */
ContactInsideBaseWithId.prototype['unsubscription_method'] = undefined;
/**
 * Contact unsubscription reason
 * @member {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionReasonEnum} unsubscription_reason
 */
ContactInsideBaseWithId.prototype['unsubscription_reason'] = undefined;
/**
 * Contact unsubscription observation
 * @member {String} unsubscription_observation
 */
ContactInsideBaseWithId.prototype['unsubscription_observation'] = undefined;
/**
 * Contact unsubscription date
 * @member {Date} unsubscription_date
 */
ContactInsideBaseWithId.prototype['unsubscription_date'] = undefined;
/**
 * Last modification date of the contact
 * @member {Date} change_date
 */
ContactInsideBaseWithId.prototype['change_date'] = undefined;
/**
 * First name of the contact
 * @member {String} first_name
 */
ContactInsideBaseWithId.prototype['first_name'] = undefined;
/**
 * Last name of the contact
 * @member {String} last_name
 */
ContactInsideBaseWithId.prototype['last_name'] = undefined;
/**
 * Birth date of the contact
 * @member {Date} birth_date
 */
ContactInsideBaseWithId.prototype['birth_date'] = undefined;
/**
 * @member {module:egoisdk/Language} language
 */
ContactInsideBaseWithId.prototype['language'] = undefined;
/**
 * Email of the contact
 * @member {String} email
 */
ContactInsideBaseWithId.prototype['email'] = undefined;
/**
 * Email channel status
 * @member {module:egoisdk/ContactInsideBaseWithId.EmailStatusEnum} email_status
 * @default 'active'
 */
ContactInsideBaseWithId.prototype['email_status'] = 'active';
/**
 * Cellphone of the contact
 * @member {String} cellphone
 */
ContactInsideBaseWithId.prototype['cellphone'] = undefined;
/**
 * Cellphone channel status
 * @member {module:egoisdk/ContactInsideBaseWithId.CellphoneStatusEnum} cellphone_status
 * @default 'active'
 */
ContactInsideBaseWithId.prototype['cellphone_status'] = 'active';
/**
 * Phone of the contact
 * @member {String} phone
 */
ContactInsideBaseWithId.prototype['phone'] = undefined;
/**
 * Phone channel status
 * @member {module:egoisdk/ContactInsideBaseWithId.PhoneStatusEnum} phone_status
 * @default 'active'
 */
ContactInsideBaseWithId.prototype['phone_status'] = 'active';
/**
 * Android push token of the contact
 * @member {Array.<module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenAndroidInner>} push_token_android
 */
ContactInsideBaseWithId.prototype['push_token_android'] = undefined;
/**
 * IOS push token of the contact
 * @member {Array.<module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBasePushTokenIosInner>} push_token_ios
 */
ContactInsideBaseWithId.prototype['push_token_ios'] = undefined;
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['StatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['ConsentEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['SubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['UnsubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['UnsubscriptionReasonEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseFieldsWithIdSchemaBase['PhoneStatusEnum'] = {
...
export default ContactBaseFieldsWithIdSchemaBase;
