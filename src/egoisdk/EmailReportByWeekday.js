...
/**
 * The EmailReportByWeekday model module.
 * @module egoisdk/EmailReportByWeekday
 * @version 1.1.6RC1
 */
class EmailReportByWeekday {
    /**
     * Constructs a new <code>EmailReportByWeekday</code>.
     * Email stats grouped by Weekday
     * @alias module:egoisdk/EmailReportByWeekday
     */
    constructor() { 
        
        EmailReportByWeekday.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByWeekday</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByWeekday} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByWeekday} The populated <code>EmailReportByWeekday</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByWeekday();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByWeekday</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByWeekday</code>.
     */
...
export default EmailReportByWeekday;
