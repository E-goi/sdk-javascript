...
class SegmentsWithoutContactActionSend {
    ...
    constructor() { 
        ...
        SegmentsWithoutContactActionSend.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SegmentsWithoutContactActionSend();
    ...
    /**
     * Validates the JSON data with respect to <code>SegmentsWithoutContactActionSend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SegmentsWithoutContactActionSend</code>.
     */
...
export default SegmentsWithoutContactActionSend;
