...
import ProductPatchRequestRelatedProducts from './ProductPatchRequestRelatedProducts';
...
class ProductPatchRequest {
    ...
    static validateJSON(data) {
        ...
        if (data['related_products']) { // data not null
          ProductPatchRequestRelatedProducts.validateJSON(data['related_products']);
        }
