...
import FieldInUseErrors from './FieldInUseErrors';
...
class DeleteFieldsConflict {
     ...
     */
    constructor() { 
        FieldInUse.initialize(this);BaseConflict.initialize(this);
        DeleteFieldsConflict.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFieldsConflict();
            FieldInUse.constructFromObject(data, obj);
            BaseConflict.constructFromObject(data, obj);

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = FieldInUseErrors.constructFromObject(data['errors']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFieldsConflict</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFieldsConflict</code>.
     */
    static validateJSON(data) {
        // validate the optional field `errors`
        if (data['errors']) { // data not null
          FieldInUseErrors.validateJSON(data['errors']);
        }
...
/**
     * @return {module:egoisdk/FieldInUseErrors}
     */
    getErrors() {
        return this.errors;
    }
    ...
    /**
     * @param {module:egoisdk/FieldInUseErrors} errors
     */
    setErrors(errors) {
        this['errors'] = errors;
    }
...
/**
     * Returns Error title
     * @return {module:egoisdk/DeleteFieldsConflict.TitleEnum}
     */
    getTitle() {
        return this.title;
    }
    ...
    /**
     * Sets Error title
     * @param {module:egoisdk/DeleteFieldsConflict.TitleEnum} title Error title
     */
    setTitle(title) {
        this['title'] = title;
    }
 ...
 */
DeleteFieldsConflict.prototype['errors'] = undefined;

/**
 * RFC for status code definitions
 * @member {String} type
 */
DeleteFieldsConflict.prototype['type'] = undefined;

/**
 * Error title
 * @member {module:egoisdk/DeleteFieldsConflict.TitleEnum} title
 */
DeleteFieldsConflict.prototype['title'] = undefined;

/**
 * Status code
 * @member {Number} status
 */
DeleteFieldsConflict.prototype['status'] = undefined;

/**
 * Error detail
 * @member {String} detail
 */
DeleteFieldsConflict.prototype['detail'] = undefined;
 ...
 * @member {module:egoisdk/FieldInUseErrors} errors
 */
FieldInUse.prototype['errors'] = undefined;
 ...
 * @readonly
 */
DeleteFieldsConflict['TitleEnum'] = {
...
export default DeleteFieldsConflict;
