...
import EmailEventsCampaignFields from './EmailEventsCampaignFields';
import EmailEventsListStatsFields from './EmailEventsListStatsFields';
...
class AdvancedReportEmailEventsColumns {
    ...
    constructor(listBaseFields, listExtraFields, listStatsFields, campaignFields) { 
        ...
        AdvancedReportEmailEventsColumns.initialize(this, listBaseFields, listExtraFields, listStatsFields, campaignFields);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdvancedReportEmailEventsColumns();
    ...
    /**
     * Validates the JSON data with respect to <code>AdvancedReportEmailEventsColumns</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdvancedReportEmailEventsColumns</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdvancedReportEmailEventsColumns.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['list_stats_fields']) { // data not null
          EmailEventsListStatsFields.validateJSON(data['list_stats_fields']);
        }
        // validate the optional field `campaign_fields`
        if (data['campaign_fields']) { // data not null
          EmailEventsCampaignFields.validateJSON(data['campaign_fields']);
        }
...
AdvancedReportEmailEventsColumns.RequiredProperties = ["list_base_fields", "list_extra_fields", "list_stats_fields", "campaign_fields"];

/**
 * Array of base fields
 * @member {Array.<String>} list_base_fields
 */
AdvancedReportEmailEventsColumns.prototype['list_base_fields'] = undefined;

/**
 * @member {Array.<module:egoisdk/AdvancedReportListExtraFieldsInner>} list_extra_fields
 */
AdvancedReportEmailEventsColumns.prototype['list_extra_fields'] = undefined;

/**
 * @member {module:egoisdk/EmailEventsListStatsFields} list_stats_fields
 */
AdvancedReportEmailEventsColumns.prototype['list_stats_fields'] = undefined;

/**
 * @member {module:egoisdk/EmailEventsCampaignFields} campaign_fields
 */
AdvancedReportEmailEventsColumns.prototype['campaign_fields'] = undefined;
...
export default AdvancedReportEmailEventsColumns;
