 ...
 * @module egoisdk/EmailClicksByContactListStatsFields
 * @version 1.1.6RC1
 */
class EmailClicksByContactListStatsFields {
     ...
     * @alias module:egoisdk/EmailClicksByContactListStatsFields
     ...
     * @param {module:egoisdk/EmailClicksByContactListStatsFields} obj Optional instance to populate.
     * @return {module:egoisdk/EmailClicksByContactListStatsFields} The populated <code>EmailClicksByContactListStatsFields</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>EmailClicksByContactListStatsFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailClicksByContactListStatsFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailClicksByContactListStatsFields.RequiredProperties) {
            if (!data[property]) {
...
EmailClicksByContactListStatsFields.RequiredProperties = ["clicks"];
