...
/**
 * The ContactInsideBaseWithId model module.
 * @module egoisdk/ContactInsideBaseWithId
 * @version 1.1.6RC1
 */
class ContactInsideBaseWithId {
    /**
     * Constructs a new <code>ContactInsideBaseWithId</code>.
     * @alias module:egoisdk/ContactInsideBaseWithId
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ContactInsideBaseWithId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactInsideBaseWithId} obj Optional instance to populate.
     * @return {module:egoisdk/ContactInsideBaseWithId} The populated <code>ContactInsideBaseWithId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactInsideBaseWithId();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactInsideBaseWithId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactInsideBaseWithId</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.StatusEnum} status Status of the contact
     */
    setStatus(status) {
        this['status'] = status;
    }
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.ConsentEnum}
     */
    getConsent() {
        return this.consent;
    }
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.ConsentEnum} consent Contact consent
     */
    setConsent(consent) {
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.SubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.SubscriptionMethodEnum} subscriptionMethod Contact subscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionMethodEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionMethodEnum} unsubscriptionMethod Contact unsubscription method
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionReasonEnum}
     */
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.UnsubscriptionReasonEnum} unsubscriptionReason Contact unsubscription reason
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.EmailStatusEnum}
     */
    getEmailStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.EmailStatusEnum} emailStatus Email channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.CellphoneStatusEnum}
     */
    getCellphoneStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.CellphoneStatusEnum} cellphoneStatus Cellphone channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactInsideBaseWithId.PhoneStatusEnum}
     */
    getPhoneStatus() {
     ...
     * @param {module:egoisdk/ContactInsideBaseWithId.PhoneStatusEnum} phoneStatus Phone channel status
     */
 ...
 * @readonly
 */
ContactInsideBaseWithId['StatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['ConsentEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['SubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['UnsubscriptionMethodEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['UnsubscriptionReasonEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactInsideBaseWithId['PhoneStatusEnum'] = {
...
export default ContactInsideBaseWithId;
