...
class EmailReportByLocation {
    /**
     * Constructs a new <code>EmailReportByLocation</code>.
     * Email stats grouped by Location
     * @alias module:egoisdk/EmailReportByLocation
     */
    constructor() { 
        
        EmailReportByLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByLocation} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByLocation} The populated <code>EmailReportByLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByLocation</code>.
     */
...
export default EmailReportByLocation;
