...
class PostProductsConflict {
    ...
    /**
     * Validates the JSON data with respect to <code>PostProductsConflict</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostProductsConflict</code>.
     */
...
/**
     * Returns Error title
     * @return {module:egoisdk/PostProductsConflict.TitleEnum}
     */
    getTitle() {
        return this.title;
    }
    ...
    /**
     * Sets Error title
     * @param {module:egoisdk/PostProductsConflict.TitleEnum} title Error title
     */
    setTitle(title) {
        this['title'] = title;
    }
...
/**
 * Error title
 * @member {module:egoisdk/PostProductsConflict.TitleEnum} title
 */
