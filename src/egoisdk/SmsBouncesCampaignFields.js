...
class SmsBouncesCampaignFields {
     ...
     */
    constructor(internalName, campaignHash, sendDate, sender) { 
        
        SmsBouncesCampaignFields.initialize(this, internalName, campaignHash, sendDate, sender);
    }
     ...
     */
    static initialize(obj, internalName, campaignHash, sendDate, sender) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmsBouncesCampaignFields();
    ...
    /**
     * Validates the JSON data with respect to <code>SmsBouncesCampaignFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmsBouncesCampaignFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SmsBouncesCampaignFields.RequiredProperties) {
            if (!data[property]) {
...
export default SmsBouncesCampaignFields;
