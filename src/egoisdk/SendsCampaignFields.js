...
class SendsCampaignFields {
     ...
     */
    constructor(internalName, campaignHash, group, channel, type, sender) { 
        
        SendsCampaignFields.initialize(this, internalName, campaignHash, group, channel, type, sender);
    }
     ...
     */
    static initialize(obj, internalName, campaignHash, group, channel, type, sender) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendsCampaignFields();
    ...
    /**
     * Validates the JSON data with respect to <code>SendsCampaignFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendsCampaignFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SendsCampaignFields.RequiredProperties) {
            if (!data[property]) {
...
export default SendsCampaignFields;
