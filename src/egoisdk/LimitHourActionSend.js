...
class LimitHourActionSend {
    /**
     * Constructs a new <code>LimitHourActionSend</code>.
     * Selection of hour interval
     * @alias module:egoisdk/LimitHourActionSend
     */
    constructor() { 
        
        LimitHourActionSend.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LimitHourActionSend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/LimitHourActionSend} obj Optional instance to populate.
     * @return {module:egoisdk/LimitHourActionSend} The populated <code>LimitHourActionSend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LimitHourActionSend();
    ...
    /**
     * Validates the JSON data with respect to <code>LimitHourActionSend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LimitHourActionSend</code>.
     */
...
export default LimitHourActionSend;
