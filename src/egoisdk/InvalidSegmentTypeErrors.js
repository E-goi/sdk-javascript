...
class InvalidSegmentTypeErrors {
    ...
    constructor() { 
        ...
        InvalidSegmentTypeErrors.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvalidSegmentTypeErrors();
    ...
    /**
     * Validates the JSON data with respect to <code>InvalidSegmentTypeErrors</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvalidSegmentTypeErrors</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['invalid_segment_type'] && !(typeof data['invalid_segment_type'] === 'string' || data['invalid_segment_type'] instanceof String)) {
            throw new Error("Expected the field `invalid_segment_type` to be a primitive type in the JSON string but got " + data['invalid_segment_type']);
        }
...
/**
     ...
     */
    setInvalidSegmentType(invalidSegmentType) {
 ...
 */
InvalidSegmentTypeErrors.prototype['invalid_segment_type'] = undefined;
 ...
 * @readonly
 */
InvalidSegmentTypeErrors['InvalidSegmentTypeEnum'] = {
...
export default InvalidSegmentTypeErrors;
