...
/**
 * The PhoneReportAllOfNetworks model module.
 * @module egoisdk/PhoneReportAllOfNetworks
 * @version 1.1.6RC1
 */
class PhoneReportAllOfNetworks {
    /**
     * Constructs a new <code>PhoneReportAllOfNetworks</code>.
     * @alias module:egoisdk/PhoneReportAllOfNetworks
     */
    constructor() { 
        
        PhoneReportAllOfNetworks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PhoneReportAllOfNetworks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/PhoneReportAllOfNetworks} obj Optional instance to populate.
     * @return {module:egoisdk/PhoneReportAllOfNetworks} The populated <code>PhoneReportAllOfNetworks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneReportAllOfNetworks();
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneReportAllOfNetworks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneReportAllOfNetworks</code>.
     */
 ...
 */
PhoneReportAllOfNetworks.prototype['network'] = undefined;

/**
 * Total number of sent messages
 * @member {Number} sends
 */
PhoneReportAllOfNetworks.prototype['sends'] = undefined;

/**
 * Total number of delivered messages
 * @member {Number} delivered
 */
PhoneReportAllOfNetworks.prototype['delivered'] = undefined;

/**
 * Total number of failed messages
 * @member {Number} error
 */
PhoneReportAllOfNetworks.prototype['error'] = undefined;

/**
 * Total number of invalid messages
 * @member {Number} invalid
 */
PhoneReportAllOfNetworks.prototype['invalid'] = undefined;

/**
 * Total number of pending messages
 * @member {Number} pending
 */
PhoneReportAllOfNetworks.prototype['pending'] = undefined;
...
export default PhoneReportAllOfNetworks;
