...
class ImportBulkFileRequestSchema {
     ...
     * @param mode {module:egoisdk/ImportBulkFileRequestSchema.ModeEnum} Add new contacts only ('add') or add and replace existing ones ('update')
...
/**
     ...
     * @param {module:egoisdk/ImportBulkFileRequestSchema.ModeEnum} mode Add new contacts only ('add') or add and replace existing ones ('update')
     */
    setMode(mode) {
        this['mode'] = mode;
    }
