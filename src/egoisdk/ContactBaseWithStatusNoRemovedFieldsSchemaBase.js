...
/**
 * The ContactBaseWithStatusNoRemovedFieldsSchemaBase model module.
 * @module egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase
 * @version 1.1.6RC1
 */
class ContactBaseWithStatusNoRemovedFieldsSchemaBase {
    /**
     * Constructs a new <code>ContactBaseWithStatusNoRemovedFieldsSchemaBase</code>.
     * Contact base fields
     * @alias module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase
     */
    constructor() { 
        
        ContactBaseWithStatusNoRemovedFieldsSchemaBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactBaseWithStatusNoRemovedFieldsSchemaBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase} obj Optional instance to populate.
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase} The populated <code>ContactBaseWithStatusNoRemovedFieldsSchemaBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactBaseWithStatusNoRemovedFieldsSchemaBase();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactBaseWithStatusNoRemovedFieldsSchemaBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactBaseWithStatusNoRemovedFieldsSchemaBase</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.StatusEnum} status Status of the contact
     */
    setStatus(status) {
        this['status'] = status;
    }
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.ConsentEnum}
     */
    getConsent() {
        return this.consent;
    }
     ...
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.ConsentEnum} consent Contact consent
     */
    setConsent(consent) {
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.EmailStatusEnum}
     */
    getEmailStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.EmailStatusEnum} emailStatus Email channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.CellphoneStatusEnum}
     */
    getCellphoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.CellphoneStatusEnum} cellphoneStatus Cellphone channel status
     */
...
/**
     ...
     * @return {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.PhoneStatusEnum}
     */
    getPhoneStatus() {
     ...
     * @param {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.PhoneStatusEnum} phoneStatus Phone channel status
     */
 ...
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['contact_id'] = undefined;

/**
 * Status of the contact
 * @member {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.StatusEnum} status
 * @default 'active'
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['status'] = 'active';

/**
 * Contact consent
 * @member {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.ConsentEnum} consent
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['consent'] = undefined;

/**
 * First name of the contact
 * @member {String} first_name
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['first_name'] = undefined;

/**
 * Last name of the contact
 * @member {String} last_name
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['last_name'] = undefined;

/**
 * Birth date of the contact
 * @member {Date} birth_date
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['birth_date'] = undefined;

/**
 * @member {module:egoisdk/Language} language
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['language'] = undefined;

/**
 * Email of the contact
 * @member {String} email
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['email'] = undefined;

/**
 * Email channel status
 * @member {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.EmailStatusEnum} email_status
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['email_status'] = undefined;

/**
 * Cellphone of the contact (country code followed by phone number, split by '-')
 * @member {String} cellphone
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['cellphone'] = undefined;

/**
 * Cellphone channel status
 * @member {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.CellphoneStatusEnum} cellphone_status
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['cellphone_status'] = undefined;

/**
 * Phone of the contact (country code followed by phone number, split by '-')
 * @member {String} phone
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['phone'] = undefined;

/**
 * Phone channel status
 * @member {module:egoisdk/ContactBaseWithStatusNoRemovedFieldsSchemaBase.PhoneStatusEnum} phone_status
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['phone_status'] = undefined;
 ...
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['push_token_android'] = undefined;
 ...
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase.prototype['push_token_ios'] = undefined;
 ...
 * @readonly
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase['StatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase['ConsentEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactBaseWithStatusNoRemovedFieldsSchemaBase['PhoneStatusEnum'] = {
...
export default ContactBaseWithStatusNoRemovedFieldsSchemaBase;
