...
class Cart {
     ...
     * @param {module:egoisdk/Cart} obj Optional instance to populate.
     * @return {module:egoisdk/Cart} The populated <code>Cart</code> instance.
     */
 ...
 */
Cart.prototype['cart_total'] = undefined;

/**
 * @member {module:egoisdk/Contact1} contact
 */
Cart.prototype['contact'] = undefined;

/**
 * List of products
 * @member {Array.<module:egoisdk/Product>} products
 */
Cart.prototype['products'] = undefined;
