...
import AdvancedReportSmsEventsColumns from './AdvancedReportSmsEventsColumns';
import AdvancedReportSmsEventsOptions from './AdvancedReportSmsEventsOptions';
...
class GenerateSmsEventsReport {
    ...
    constructor(title, range, campaigns, columns, options) { 
        ...
        GenerateSmsEventsReport.initialize(this, title, range, campaigns, columns, options);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateSmsEventsReport();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateSmsEventsReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateSmsEventsReport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateSmsEventsReport.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['columns']) { // data not null
          AdvancedReportSmsEventsColumns.validateJSON(data['columns']);
        }
        // validate the optional field `options`
        if (data['options']) { // data not null
          AdvancedReportSmsEventsOptions.validateJSON(data['options']);
        }
        // ensure the json data is a string
...
GenerateSmsEventsReport.RequiredProperties = ["title", "range", "campaigns", "columns", "options"];

/**
 * Advanced report title
 * @member {String} title
 */
GenerateSmsEventsReport.prototype['title'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportRange} range
 */
GenerateSmsEventsReport.prototype['range'] = undefined;

/**
 * Campaigns of the report
 * @member {Array.<module:egoisdk/AdvancedReportCampaignsObject>} campaigns
 */
GenerateSmsEventsReport.prototype['campaigns'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportSmsEventsColumns} columns
 */
GenerateSmsEventsReport.prototype['columns'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportSmsEventsOptions} options
 */
GenerateSmsEventsReport.prototype['options'] = undefined;
 ...
 */
GenerateSmsEventsReport.prototype['callback_url'] = undefined;
...
export default GenerateSmsEventsReport;
