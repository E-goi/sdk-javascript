...
class EmailCampaignPatch {
    ...
    /**
     * Validates the JSON data with respect to <code>EmailCampaignPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailCampaignPatch</code>.
     */
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
          CampaignEmailContentHtmlPatch.validateJSON(data['content']);
        }
