...
class GeneralInfo {
     ...
     * General info schema
     * @alias module:egoisdk/GeneralInfo
     * @implements module:egoisdk/GeneralInfoAllOf
     */
    constructor() { 
     ...
     * @param {module:egoisdk/GeneralInfo} obj Optional instance to populate.
     * @return {module:egoisdk/GeneralInfo} The populated <code>GeneralInfo</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GeneralInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeneralInfo</code>.
     */
