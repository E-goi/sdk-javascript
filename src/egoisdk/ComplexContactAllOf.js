 ...
 * @module egoisdk/ComplexContactAllOf
 * @version 1.1.2RC1
 */
class ComplexContactAllOf {
    /**
     * Constructs a new <code>ComplexContactAllOf</code>.
     * @alias module:egoisdk/ComplexContactAllOf
     */
    constructor() { 
     ...
     * @param {module:egoisdk/ComplexContactAllOf} obj Optional instance to populate.
     * @return {module:egoisdk/ComplexContactAllOf} The populated <code>ComplexContactAllOf</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ComplexContactAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComplexContactAllOf</code>.
     */
