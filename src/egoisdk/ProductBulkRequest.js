...
class ProductBulkRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>ProductBulkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductBulkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProductBulkRequest.RequiredProperties) {
            if (!data[property]) {
...
ProductBulkRequest.RequiredProperties = ["products"];
