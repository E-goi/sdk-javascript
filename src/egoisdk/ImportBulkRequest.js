...
class ImportBulkRequest {
     ...
     * @param mode {module:egoisdk/ImportBulkRequest.ModeEnum} Add new contacts only ('add'), add and replace existing ones ('update') or only replace existing ones ('update_only')
     ...
     */
    constructor(mode, compareField, contacts) { 
        
        ImportBulkRequest.initialize(this, mode, compareField, contacts);
    }
     ...
     */
    static initialize(obj, mode, compareField, contacts) { 
        obj['mode'] = mode;
    ...
    /**
     * Validates the JSON data with respect to <code>ImportBulkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportBulkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportBulkRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['contacts']) { // data not null
            ...
            for (const item of data['contacts']) {
                ContactBulk.validateJsonObject(item);
            };
        }
        // ensure the json data is an array
...
/**
     ...
     * @param {module:egoisdk/ImportBulkRequest.ModeEnum} mode Add new contacts only ('add'), add and replace existing ones ('update') or only replace existing ones ('update_only')
     */
    setMode(mode) {
        this['mode'] = mode;
    }
...
ImportBulkRequest.RequiredProperties = ["mode", "compare_field", "contacts"];
 ...
 */
ImportBulkRequest.prototype['mode'] = undefined;
 ...
 * @default false
 */
ImportBulkRequest.prototype['force_empty'] = false;

/**
 * Array of IDs of the users to notify
 * @member {Array.<Number>} notify
 */
ImportBulkRequest.prototype['notify'] = undefined;
 ...
 */
ImportBulkRequest.prototype['callback_url'] = undefined;
