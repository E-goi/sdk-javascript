...
class EmailUnsubscriptionsCampaignFields {
    ...
    /**
     * Validates the JSON data with respect to <code>EmailUnsubscriptionsCampaignFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailUnsubscriptionsCampaignFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailUnsubscriptionsCampaignFields.RequiredProperties) {
            if (!data[property]) {
...
EmailUnsubscriptionsCampaignFields.RequiredProperties = ["internal_name", "campaign_hash", "sender"];
 ...
 */
EmailUnsubscriptionsCampaignFields.prototype['send_date'] = undefined;

/**
 * True to include the group of the campaign, false otherwise
 * @member {Boolean} group
 */
EmailUnsubscriptionsCampaignFields.prototype['group'] = undefined;

/**
 * True to include the channel of the campaign, false otherwise
 * @member {Boolean} channel
 */
EmailUnsubscriptionsCampaignFields.prototype['channel'] = undefined;

/**
 * True to include the type of the campaign, false otherwise
 * @member {Boolean} type
 */
EmailUnsubscriptionsCampaignFields.prototype['type'] = undefined;
