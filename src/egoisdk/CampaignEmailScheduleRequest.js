...
class CampaignEmailScheduleRequest {
     ...
     * @alias module:egoisdk/CampaignEmailScheduleRequest
     ...
     * @param {module:egoisdk/CampaignEmailScheduleRequest} obj Optional instance to populate.
     * @return {module:egoisdk/CampaignEmailScheduleRequest} The populated <code>CampaignEmailScheduleRequest</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignEmailScheduleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignEmailScheduleRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CampaignEmailScheduleRequest.RequiredProperties) {
            if (!data[property]) {
...
CampaignEmailScheduleRequest.RequiredProperties = ["list_id", "segments"];
