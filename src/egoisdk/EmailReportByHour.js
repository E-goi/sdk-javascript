...
class EmailReportByHour {
    /**
     * Constructs a new <code>EmailReportByHour</code>.
     * Email stats grouped by Hour
     * @alias module:egoisdk/EmailReportByHour
     */
    constructor() { 
        
        EmailReportByHour.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByHour</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByHour} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByHour} The populated <code>EmailReportByHour</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByHour();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByHour</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByHour</code>.
     */
...
export default EmailReportByHour;
