...
import AdvancedReportEmailEventsColumns from './AdvancedReportEmailEventsColumns';
import AdvancedReportEmailEventsOptions from './AdvancedReportEmailEventsOptions';
import AdvancedReportRange from './AdvancedReportRange';

/**
 * The GenerateEmailEventsReport model module.
 * @module egoisdk/GenerateEmailEventsReport
 * @version 1.1.6RC1
 */
class GenerateEmailEventsReport {
    /**
     * Constructs a new <code>GenerateEmailEventsReport</code>.
     * Generate email events report schema
     * @alias module:egoisdk/GenerateEmailEventsReport
     ...
     * @param columns {module:egoisdk/AdvancedReportEmailEventsColumns} 
     * @param options {module:egoisdk/AdvancedReportEmailEventsOptions} 
     */
    constructor(title, range, campaigns, columns, options) { 
        
        GenerateEmailEventsReport.initialize(this, title, range, campaigns, columns, options);
    }
    ...
    /**
     * Constructs a <code>GenerateEmailEventsReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/GenerateEmailEventsReport} obj Optional instance to populate.
     * @return {module:egoisdk/GenerateEmailEventsReport} The populated <code>GenerateEmailEventsReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateEmailEventsReport();
            ...
            if (data.hasOwnProperty('columns')) {
                obj['columns'] = AdvancedReportEmailEventsColumns.constructFromObject(data['columns']);
            }
            if (data.hasOwnProperty('options')) {
                obj['options'] = AdvancedReportEmailEventsOptions.constructFromObject(data['options']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateEmailEventsReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateEmailEventsReport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateEmailEventsReport.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['columns']) { // data not null
          AdvancedReportEmailEventsColumns.validateJSON(data['columns']);
        }
        // validate the optional field `options`
        if (data['options']) { // data not null
          AdvancedReportEmailEventsOptions.validateJSON(data['options']);
        }
        // ensure the json data is a string
...
/**
     * @return {module:egoisdk/AdvancedReportEmailEventsColumns}
     */
    getColumns() {
        return this.columns;
    }
    ...
    /**
     * @param {module:egoisdk/AdvancedReportEmailEventsColumns} columns
     */
    setColumns(columns) {
        this['columns'] = columns;
    }
/**
     * @return {module:egoisdk/AdvancedReportEmailEventsOptions}
     */
    getOptions() {
        return this.options;
    }
    ...
    /**
     * @param {module:egoisdk/AdvancedReportEmailEventsOptions} options
     */
    setOptions(options) {
...
GenerateEmailEventsReport.RequiredProperties = ["title", "range", "campaigns", "columns", "options"];

/**
 * Advanced report title
 * @member {String} title
 */
GenerateEmailEventsReport.prototype['title'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportRange} range
 */
GenerateEmailEventsReport.prototype['range'] = undefined;

/**
 * Campaigns of the report
 * @member {Array.<module:egoisdk/AdvancedReportCampaignsObject>} campaigns
 */
GenerateEmailEventsReport.prototype['campaigns'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportEmailEventsColumns} columns
 */
GenerateEmailEventsReport.prototype['columns'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportEmailEventsOptions} options
 */
GenerateEmailEventsReport.prototype['options'] = undefined;
 ...
 */
GenerateEmailEventsReport.prototype['callback_url'] = undefined;
...
export default GenerateEmailEventsReport;
