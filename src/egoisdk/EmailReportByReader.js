...
/**
 * The EmailReportByReader model module.
 * @module egoisdk/EmailReportByReader
 * @version 1.1.6RC1
 */
class EmailReportByReader {
    /**
     * Constructs a new <code>EmailReportByReader</code>.
     * Email stats grouped by Reader
     * @alias module:egoisdk/EmailReportByReader
     */
    constructor() { 
        
        EmailReportByReader.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByReader</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByReader} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByReader} The populated <code>EmailReportByReader</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByReader();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByReader</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByReader</code>.
     */
...
export default EmailReportByReader;
