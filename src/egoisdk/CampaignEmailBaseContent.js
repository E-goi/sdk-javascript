...
/**
 * The CampaignEmailBaseContent model module.
 * @module egoisdk/CampaignEmailBaseContent
 * @version 1.1.6RC1
 */
class CampaignEmailBaseContent {
    /**
     * Constructs a new <code>CampaignEmailBaseContent</code>.
     * @alias module:egoisdk/CampaignEmailBaseContent
     */
    constructor() { 
        
        CampaignEmailBaseContent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignEmailBaseContent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/CampaignEmailBaseContent} obj Optional instance to populate.
     * @return {module:egoisdk/CampaignEmailBaseContent} The populated <code>CampaignEmailBaseContent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignEmailBaseContent();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignEmailBaseContent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignEmailBaseContent</code>.
     */
...
export default CampaignEmailBaseContent;
