...
/**
 * The PatchRequestList model module.
 * @module egoisdk/PatchRequestList
 * @version 1.1.6RC1
 */
class PatchRequestList {
    /**
     * Constructs a new <code>PatchRequestList</code>.
     * Patch request lists schema
     * @alias module:egoisdk/PatchRequestList
     */
    constructor() { 
        
        PatchRequestList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchRequestList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/PatchRequestList} obj Optional instance to populate.
     * @return {module:egoisdk/PatchRequestList} The populated <code>PatchRequestList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchRequestList();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchRequestList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchRequestList</code>.
     */
 ...
 */
PatchRequestList.prototype['internal_name'] = undefined;

/**
 * Public name of the list
 * @member {String} public_name
 */
PatchRequestList.prototype['public_name'] = undefined;

/**
 * @member {Number} group_id
 */
PatchRequestList.prototype['group_id'] = undefined;
...
export default PatchRequestList;
