...
/**
 * The EmailClicksByContactCampaignFields model module.
 * @module egoisdk/EmailClicksByContactCampaignFields
 * @version 1.1.6RC1
 */
class EmailClicksByContactCampaignFields {
    /**
     * Constructs a new <code>EmailClicksByContactCampaignFields</code>.
     * Campaign fields to include in the report
     * @alias module:egoisdk/EmailClicksByContactCampaignFields
    ...
    constructor(internalName, campaignHash, url) { 
        ...
        EmailClicksByContactCampaignFields.initialize(this, internalName, campaignHash, url);
    }
    ...
    /**
     * Constructs a <code>EmailClicksByContactCampaignFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailClicksByContactCampaignFields} obj Optional instance to populate.
     * @return {module:egoisdk/EmailClicksByContactCampaignFields} The populated <code>EmailClicksByContactCampaignFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailClicksByContactCampaignFields();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailClicksByContactCampaignFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailClicksByContactCampaignFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailClicksByContactCampaignFields.RequiredProperties) {
            if (!data[property]) {
...
export default EmailClicksByContactCampaignFields;
