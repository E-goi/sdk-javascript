...
class EmailClicksByContactCampaignFields {
    ...
    constructor(internalName, campaignHash, url, city, country, region, program, os) { 
        ...
        EmailClicksByContactCampaignFields.initialize(this, internalName, campaignHash, url, city, country, region, program, os);
    }
...
EmailClicksByContactCampaignFields.RequiredProperties = ["internal_name", "campaign_hash", "url", "city", "country", "region", "program", "os"];
