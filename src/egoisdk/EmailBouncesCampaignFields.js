...
/**
 * The EmailBouncesCampaignFields model module.
 * @module egoisdk/EmailBouncesCampaignFields
 * @version 1.1.6RC1
 */
class EmailBouncesCampaignFields {
    /**
     * Constructs a new <code>EmailBouncesCampaignFields</code>.
     * Campaign fields to include in the report
     * @alias module:egoisdk/EmailBouncesCampaignFields
     ...
     */
    constructor(internalName, campaignHash) { 
        
        EmailBouncesCampaignFields.initialize(this, internalName, campaignHash);
    }
     ...
     */
    static initialize(obj, internalName, campaignHash) { 
        obj['internal_name'] = internalName;
        obj['campaign_hash'] = campaignHash;
    }

    /**
     * Constructs a <code>EmailBouncesCampaignFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailBouncesCampaignFields} obj Optional instance to populate.
     * @return {module:egoisdk/EmailBouncesCampaignFields} The populated <code>EmailBouncesCampaignFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailBouncesCampaignFields();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailBouncesCampaignFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailBouncesCampaignFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailBouncesCampaignFields.RequiredProperties) {
            if (!data[property]) {
...
export default EmailBouncesCampaignFields;
