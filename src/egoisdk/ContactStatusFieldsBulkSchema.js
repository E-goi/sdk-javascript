...
class ContactStatusFieldsBulkSchema {
    ...
    constructor() { 
        ...
        ContactStatusFieldsBulkSchema.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactStatusFieldsBulkSchema();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactStatusFieldsBulkSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactStatusFieldsBulkSchema</code>.
     */
 ...
 * @readonly
 */
ContactStatusFieldsBulkSchema['EmailStatusEnum'] = {
 ...
 * @readonly
 */
ContactStatusFieldsBulkSchema['CellphoneStatusEnum'] = {
 ...
 * @readonly
 */
ContactStatusFieldsBulkSchema['PhoneStatusEnum'] = {
...
export default ContactStatusFieldsBulkSchema;
