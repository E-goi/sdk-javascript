...
class WebPushSite {
     ...
     * @param site {String} Webpush site
     * @param listId {Number} 
     * @param name {String} Webpush name
     */
    constructor(site, listId, name) { 
        
        WebPushSite.initialize(this, site, listId, name);
    }
     ...
     */
    static initialize(obj, site, listId, name) { 
        obj['site'] = site;
        obj['list_id'] = listId;
        obj['name'] = name;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WebPushSite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebPushSite</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebPushSite.RequiredProperties) {
            if (!data[property]) {
...
WebPushSite.RequiredProperties = ["site", "list_id", "name"];

/**
 * @member {Number} site_id
 */
WebPushSite.prototype['site_id'] = undefined;

/**
 * Webpush site
 * @member {String} site
 */
WebPushSite.prototype['site'] = undefined;

/**
 * @member {Number} list_id
 */
WebPushSite.prototype['list_id'] = undefined;

/**
 * App code
 * @member {String} app_code
 */
WebPushSite.prototype['app_code'] = undefined;

/**
 * Webpush name
 * @member {String} name
 */
WebPushSite.prototype['name'] = undefined;
