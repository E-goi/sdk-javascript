...
class EmailRssCampaignCreate {
    ...
    /**
     * Validates the JSON data with respect to <code>EmailRssCampaignCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailRssCampaignCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmailRssCampaignCreate.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['content']) { // data not null
          CampaignEmailRssContent.validateJSON(data['content']);
        }
...
EmailRssCampaignCreate.RequiredProperties = ["list_id", "internal_name", "content", "sender_id"];
