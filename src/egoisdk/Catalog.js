...
class Catalog {
     ...
     * @param {module:egoisdk/Catalog} obj Optional instance to populate.
     * @return {module:egoisdk/Catalog} The populated <code>Catalog</code> instance.
     */
