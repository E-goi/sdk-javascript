...
EmailEventsCampaignFields.RequiredProperties = ["internal_name", "campaign_hash", "send_date", "group"];
 ...
 */
EmailEventsCampaignFields.prototype['channel'] = undefined;

/**
 * True to include the type of the campaign, false otherwise
 * @member {Boolean} type
 */
EmailEventsCampaignFields.prototype['type'] = undefined;

/**
 * True to include the URL of the campaign, false otherwise
 * @member {Boolean} url
 */
EmailEventsCampaignFields.prototype['url'] = undefined;

/**
 * True to include the sender of the campaign, false otherwise
 * @member {Boolean} sender
 */
EmailEventsCampaignFields.prototype['sender'] = undefined;
