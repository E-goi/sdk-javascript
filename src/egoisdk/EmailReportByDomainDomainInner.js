...
/**
 * The EmailReportByDomainDomainInner model module.
 * @module egoisdk/EmailReportByDomainDomainInner
 * @version 1.1.6RC1
 */
class EmailReportByDomainDomainInner {
    /**
     * Constructs a new <code>EmailReportByDomainDomainInner</code>.
     * @alias module:egoisdk/EmailReportByDomainDomainInner
     */
    constructor() { 
        
        EmailReportByDomainDomainInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByDomainDomainInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByDomainDomainInner} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByDomainDomainInner} The populated <code>EmailReportByDomainDomainInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByDomainDomainInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByDomainDomainInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByDomainDomainInner</code>.
     */
 ...
 */
EmailReportByDomainDomainInner.prototype['domain'] = undefined;

/**
 * Total number of sent messages
 * @member {Number} sends
 */
EmailReportByDomainDomainInner.prototype['sends'] = undefined;

/**
 * Total number of open messages
 * @member {Number} opens
 */
EmailReportByDomainDomainInner.prototype['opens'] = undefined;

/**
 * Total number of clicks in message
 * @member {Number} clicks
 */
EmailReportByDomainDomainInner.prototype['clicks'] = undefined;

/**
 * Total number of hard bounces
 * @member {Number} hard_bounces
 */
EmailReportByDomainDomainInner.prototype['hard_bounces'] = undefined;

/**
 * Total number of soft bounces
 * @member {Number} soft_bounces
 */
EmailReportByDomainDomainInner.prototype['soft_bounces'] = undefined;

/**
 * Total number of complaints
 * @member {Number} complaints
 */
EmailReportByDomainDomainInner.prototype['complaints'] = undefined;

/**
 * Total number of unsubscriptions
 * @member {Number} unsubscriptions
 */
EmailReportByDomainDomainInner.prototype['unsubscriptions'] = undefined;
...
export default EmailReportByDomainDomainInner;
