...
class CampaignSentLast30Days {
    ...
    constructor() { 
        ...
        CampaignSentLast30Days.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignSentLast30Days();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignSentLast30Days</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignSentLast30Days</code>.
     */
...
export default CampaignSentLast30Days;
