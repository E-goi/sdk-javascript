...
class ContactBulkFileAllOf1 {
    /**
     * Constructs a new <code>ContactBulkFileAllOf1</code>.
     * @alias module:egoisdk/ContactBulkFileAllOf1
    ...
    constructor(fieldMapping) { 
        ...
        ContactBulkFileAllOf1.initialize(this, fieldMapping);
    }
     ...
     */
    static initialize(obj, fieldMapping) { 
        obj['field_mapping'] = fieldMapping;
    }

    /**
     * Constructs a <code>ContactBulkFileAllOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/ContactBulkFileAllOf1} obj Optional instance to populate.
     * @return {module:egoisdk/ContactBulkFileAllOf1} The populated <code>ContactBulkFileAllOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactBulkFileAllOf1();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactBulkFileAllOf1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactBulkFileAllOf1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactBulkFileAllOf1.RequiredProperties) {
            if (!data[property]) {
...
ContactBulkFileAllOf1.RequiredProperties = ["field_mapping"];
...
export default ContactBulkFileAllOf1;
