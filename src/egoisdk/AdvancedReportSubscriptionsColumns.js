...
import SubscriptionsListStatsFields from './SubscriptionsListStatsFields';
...
class AdvancedReportSubscriptionsColumns {
    /**
     * Constructs a new <code>AdvancedReportSubscriptionsColumns</code>.
     * Columns of the report
     * @alias module:egoisdk/AdvancedReportSubscriptionsColumns
     ...
     * @param listStatsFields {module:egoisdk/SubscriptionsListStatsFields} 
     */
    constructor(listBaseFields, listExtraFields, listStatsFields) { 
        
        AdvancedReportSubscriptionsColumns.initialize(this, listBaseFields, listExtraFields, listStatsFields);
    }
    ...
    /**
     * Constructs a <code>AdvancedReportSubscriptionsColumns</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/AdvancedReportSubscriptionsColumns} obj Optional instance to populate.
     * @return {module:egoisdk/AdvancedReportSubscriptionsColumns} The populated <code>AdvancedReportSubscriptionsColumns</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdvancedReportSubscriptionsColumns();
            ...
            if (data.hasOwnProperty('list_stats_fields')) {
                obj['list_stats_fields'] = SubscriptionsListStatsFields.constructFromObject(data['list_stats_fields']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdvancedReportSubscriptionsColumns</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdvancedReportSubscriptionsColumns</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdvancedReportSubscriptionsColumns.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['list_stats_fields']) { // data not null
          SubscriptionsListStatsFields.validateJSON(data['list_stats_fields']);
        }
...
/**
     * @return {module:egoisdk/SubscriptionsListStatsFields}
     */
    getListStatsFields() {
    ...
    /**
     * @param {module:egoisdk/SubscriptionsListStatsFields} listStatsFields
     */
...
AdvancedReportSubscriptionsColumns.RequiredProperties = ["list_base_fields", "list_extra_fields", "list_stats_fields"];

/**
 * Array of base fields
 * @member {Array.<String>} list_base_fields
 */
AdvancedReportSubscriptionsColumns.prototype['list_base_fields'] = undefined;

/**
 * @member {Array.<module:egoisdk/AdvancedReportListExtraFieldsInner>} list_extra_fields
 */
AdvancedReportSubscriptionsColumns.prototype['list_extra_fields'] = undefined;

/**
 * @member {module:egoisdk/SubscriptionsListStatsFields} list_stats_fields
 */
AdvancedReportSubscriptionsColumns.prototype['list_stats_fields'] = undefined;
...
export default AdvancedReportSubscriptionsColumns;
