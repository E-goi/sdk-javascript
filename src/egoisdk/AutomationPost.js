...
import AutomationPostAllOf from './AutomationPostAllOf';

/**
 * The AutomationPost model module.
 * @module egoisdk/AutomationPost
 * @version 1.1.6RC1
 */
class AutomationPost {
    /**
     * Constructs a new <code>AutomationPost</code>.
     * Automation schema
     * @alias module:egoisdk/AutomationPost
     * @implements module:egoisdk/AutomationPostAllOf
     */
    constructor() { 
        AutomationPostAllOf.initialize(this);
        AutomationPost.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutomationPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/AutomationPost} obj Optional instance to populate.
     * @return {module:egoisdk/AutomationPost} The populated <code>AutomationPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutomationPost();
            AutomationPostAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AutomationPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutomationPost</code>.
     */
...
/**
     ...
     * @return {module:egoisdk/AutomationPost.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
     ...
     * @param {module:egoisdk/AutomationPost.StatusEnum} status Automation status
     */
    setStatus(status) {
        this['status'] = status;
    }
 ...
 * @member {String} title
 */
AutomationPost.prototype['title'] = undefined;

/**
 * @member {Number} list_id
 */
AutomationPost.prototype['list_id'] = undefined;

/**
 * Automation status
 * @member {module:egoisdk/AutomationPost.StatusEnum} status
 */
AutomationPost.prototype['status'] = undefined;
 ...
 * @default true
 */
AutomationPost.prototype['allow_multiple_contacts'] = true;
 ...
 */
AutomationPost.prototype['contact_limit'] = undefined;


// Implement AutomationPostAllOf interface:
/**
 * Automation title
 * @member {String} title
 */
AutomationPostAllOf.prototype['title'] = undefined;
/**
 * @member {Number} list_id
 */
AutomationPostAllOf.prototype['list_id'] = undefined;
/**
 * Automation status
 * @member {module:egoisdk/AutomationPostAllOf.StatusEnum} status
 */
AutomationPostAllOf.prototype['status'] = undefined;
/**
 * True if the automation allows multiple contacts, false otherwise
 * @member {Boolean} allow_multiple_contacts
 * @default true
 */
AutomationPostAllOf.prototype['allow_multiple_contacts'] = true;
/**
 * Contact limit for the automation. Contact limit value (value '0' is returned if contact limit is not enabled)
 * @member {Number} contact_limit
 */
AutomationPostAllOf.prototype['contact_limit'] = undefined;
