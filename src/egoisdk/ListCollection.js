...
class ListCollection {
    ...
    constructor() { 
        ...
        ListCollection.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCollection</code>.
     */
 ...
 */
ListCollection.prototype['total_items'] = undefined;

/**
 * Returned lists
 * @member {Array.<Array>} items
 */
ListCollection.prototype['items'] = undefined;
