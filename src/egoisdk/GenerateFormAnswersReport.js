...
import AdvancedReportFormsInner from './AdvancedReportFormsInner';
...
class GenerateFormAnswersReport {
     ...
     * @param forms {Array.<module:egoisdk/AdvancedReportFormsInner>} 
     */
    constructor(title, range, forms) { 
        
        GenerateFormAnswersReport.initialize(this, title, range, forms);
    }
     ...
     */
    static initialize(obj, title, range, forms) { 
        obj['title'] = title;
        obj['range'] = range;
        obj['forms'] = forms;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateFormAnswersReport();
            ...
            if (data.hasOwnProperty('forms')) {
                obj['forms'] = ApiClient.convertToType(data['forms'], [AdvancedReportFormsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateFormAnswersReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateFormAnswersReport</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateFormAnswersReport.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['forms']) { // data not null
            ...
            for (const item of data['forms']) {
                AdvancedReportFormsInner.validateJsonObject(item);
            };
        }
        // ensure the json data is a string
...
/**
     * @return {Array.<module:egoisdk/AdvancedReportFormsInner>}
     */
    getForms() {
        return this.forms;
    }
    ...
    /**
     * @param {Array.<module:egoisdk/AdvancedReportFormsInner>} forms
     */
    setForms(forms) {
        this['forms'] = forms;
    }
...
GenerateFormAnswersReport.RequiredProperties = ["title", "range", "forms"];

/**
 * Advanced report title
 * @member {String} title
 */
GenerateFormAnswersReport.prototype['title'] = undefined;

/**
 * @member {module:egoisdk/AdvancedReportRange} range
 */
GenerateFormAnswersReport.prototype['range'] = undefined;

/**
 * @member {Array.<module:egoisdk/AdvancedReportFormsInner>} forms
 */
GenerateFormAnswersReport.prototype['forms'] = undefined;
 ...
 */
GenerateFormAnswersReport.prototype['callback_url'] = undefined;
...
export default GenerateFormAnswersReport;
