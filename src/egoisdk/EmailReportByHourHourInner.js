...
/**
 * The EmailReportByHourHourInner model module.
 * @module egoisdk/EmailReportByHourHourInner
 * @version 1.1.6RC1
 */
class EmailReportByHourHourInner {
    /**
     * Constructs a new <code>EmailReportByHourHourInner</code>.
     * @alias module:egoisdk/EmailReportByHourHourInner
     */
    constructor() { 
        
        EmailReportByHourHourInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmailReportByHourHourInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/EmailReportByHourHourInner} obj Optional instance to populate.
     * @return {module:egoisdk/EmailReportByHourHourInner} The populated <code>EmailReportByHourHourInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailReportByHourHourInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailReportByHourHourInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailReportByHourHourInner</code>.
     */
...
/**
    ...
    /**
     * Sets 24-hour format of an hour with leading zeros
     * @param {String} hour 24-hour format of an hour with leading zeros
     */
    setHour(hour) {
        this['hour'] = hour;
    }
 ...
 * @member {String} hour
 */
EmailReportByHourHourInner.prototype['hour'] = undefined;

/**
 * Total number of sent messages
 * @member {Number} sends
 */
EmailReportByHourHourInner.prototype['sends'] = undefined;

/**
 * Total number of open messages
 * @member {Number} opens
 */
EmailReportByHourHourInner.prototype['opens'] = undefined;

/**
 * Total number of clicks in message
 * @member {Number} clicks
 */
EmailReportByHourHourInner.prototype['clicks'] = undefined;

/**
 * Total number of hard bounces
 * @member {Number} hard_bounces
 */
EmailReportByHourHourInner.prototype['hard_bounces'] = undefined;

/**
 * Total number of soft bounces
 * @member {Number} soft_bounces
 */
EmailReportByHourHourInner.prototype['soft_bounces'] = undefined;

/**
 * Total number of complaints
 * @member {Number} complaints
 */
EmailReportByHourHourInner.prototype['complaints'] = undefined;

/**
 * Total number of unsubscriptions
 * @member {Number} unsubscriptions
 */
EmailReportByHourHourInner.prototype['unsubscriptions'] = undefined;
...
export default EmailReportByHourHourInner;
