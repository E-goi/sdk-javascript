...
class ComplexContact {
     ...
     * @implements module:egoisdk/ContactStats
     */
    constructor() { 
        Contact.initialize(this);ContactStats.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ContactStats.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ComplexContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ComplexContact</code>.
     */
 ...
 */
ComplexContact.prototype['traffic_stats'] = undefined;
...
// Implement ContactStats interface:
/**
 * @member {module:egoisdk/ContactStatsEmailStats} email_stats
 */
