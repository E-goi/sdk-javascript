...
class MyAccount {
    ...
    /**
     * Validates the JSON data with respect to <code>MyAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MyAccount</code>.
     */
    static validateJSON(data) {
        // validate the optional field `general_info`
        if (data['general_info']) { // data not null
          GeneralInfoAllOfGeneralInfo.validateJSON(data['general_info']);
        }
        // validate the optional field `billing_info`
        if (data['billing_info']) { // data not null
          BillingInfoAllOfBillingInfo.validateJSON(data['billing_info']);
        }
        // validate the optional field `plan_info`
        if (data['plan_info']) { // data not null
          PlanInfoPlanInfo.validateJSON(data['plan_info']);
        }
        // validate the optional field `balance_info`
        if (data['balance_info']) { // data not null
          BalanceInfoBalanceInfo.validateJSON(data['balance_info']);
        }
        // validate the optional field `module_info`
        if (data['module_info']) { // data not null
          ModuleInfoModuleInfo.validateJSON(data['module_info']);
        }
...
/**
     * @return {module:egoisdk/GeneralInfoAllOfGeneralInfo}
     */
    getGeneralInfo() {
    ...
    /**
     * @param {module:egoisdk/GeneralInfoAllOfGeneralInfo} generalInfo
     */
    setGeneralInfo(generalInfo) {
        this['general_info'] = generalInfo;
    }
/**
     * @return {module:egoisdk/BillingInfoAllOfBillingInfo}
     */
    getBillingInfo() {
    ...
    /**
     * @param {module:egoisdk/BillingInfoAllOfBillingInfo} billingInfo
     */
    setBillingInfo(billingInfo) {
        this['billing_info'] = billingInfo;
    }
/**
     * @return {module:egoisdk/PlanInfoPlanInfo}
     */
    getPlanInfo() {
    ...
    /**
     * @param {module:egoisdk/PlanInfoPlanInfo} planInfo
     */
    setPlanInfo(planInfo) {
        this['plan_info'] = planInfo;
    }
/**
     * @return {module:egoisdk/BalanceInfoBalanceInfo}
     */
    getBalanceInfo() {
    ...
    /**
     * @param {module:egoisdk/BalanceInfoBalanceInfo} balanceInfo
     */
    setBalanceInfo(balanceInfo) {
        this['balance_info'] = balanceInfo;
    }
/**
     * @return {module:egoisdk/ModuleInfoModuleInfo}
     */
    getModuleInfo() {
    ...
    /**
     * @param {module:egoisdk/ModuleInfoModuleInfo} moduleInfo
     */
...
/**
 * @member {module:egoisdk/GeneralInfoAllOfGeneralInfo} general_info
 */
MyAccount.prototype['general_info'] = undefined;

/**
 * @member {module:egoisdk/BillingInfoAllOfBillingInfo} billing_info
 */
