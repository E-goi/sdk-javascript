...
class MessageWebPush {
    /**
     * Constructs a new <code>MessageWebPush</code>.
     * @alias module:egoisdk/MessageWebPush
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MessageWebPush</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:egoisdk/MessageWebPush} obj Optional instance to populate.
     * @return {module:egoisdk/MessageWebPush} The populated <code>MessageWebPush</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageWebPush();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageWebPush</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageWebPush</code>.
     */
